...
class Diagnostic_Monitor_Rendering extends Diagnostic_Base {
  public static function check(): ?array {
	 ...
	 *
	 * Diagnostic: Monitor Rendering
	 * Slug: -monitor-rendering-performance
	 * File: class-diagnostic-monitor-rendering-performance.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__monitor_rendering_performance(): array {
		/*
