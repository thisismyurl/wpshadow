...
class Diagnostic_Monitor_Rate_Limit_Violations extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Monitor Rate Limit Violations
	 * Slug: -monitor-rate-limit-violations
	 * File: class-diagnostic-monitor-rate-limit-violations.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__monitor_rate_limit_violations(): array {
		/*
