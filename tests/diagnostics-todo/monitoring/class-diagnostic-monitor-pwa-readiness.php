...
class Diagnostic_Monitor_Pwa extends Diagnostic_Base {
  public static function check(): ?array {
	 ...
	 *
	 * Diagnostic: Monitor Pwa
	 * Slug: -monitor-pwa-readiness
	 * File: class-diagnostic-monitor-pwa-readiness.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__monitor_pwa_readiness(): array {
		/*
