...
class Diagnostic_Monitor_Gross extends Diagnostic_Base {
  public static function check(): ?array {
	 ...
	 *
	 * Diagnostic: Monitor Gross
	 * Slug: -monitor-gross-margin-quality
	 * File: class-diagnostic-monitor-gross-margin-quality.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__monitor_gross_margin_quality(): array {
		/*
