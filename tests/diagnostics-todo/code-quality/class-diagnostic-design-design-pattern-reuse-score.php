...
class Diagnostic_Design_DESIGN_PATTERN_REUSE_SCORE extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design DESIGN PATTERN REUSE SCORE
	 * Slug: -design-design-pattern-reuse-score
	 * File: class-diagnostic-design-design-pattern-reuse-score.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_design_pattern_reuse_score(): array {
		/*
