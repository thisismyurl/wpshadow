...
class Diagnostic_Inline_Script_Bloat extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Inline Script Bloat
	 * Slug: -inline-script-bloat
	 * File: class-diagnostic-inline-script-bloat.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__inline_script_bloat(): array {
		/*
