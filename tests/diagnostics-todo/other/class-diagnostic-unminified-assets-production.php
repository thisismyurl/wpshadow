...
class Diagnostic_Unminified_Assets_Production extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Unminified Assets Production
	 * Slug: -unminified-assets-production
	 * File: class-diagnostic-unminified-assets-production.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__unminified_assets_production(): array {
		/*
