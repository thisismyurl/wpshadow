...
class Diagnostic_Connection_Timeout_Too_Long extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Connection Timeout Too Long
	 * Slug: -connection-timeout-too-long
	 * File: class-diagnostic-connection-timeout-too-long.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__connection_timeout_too_long(): array {
		/*
