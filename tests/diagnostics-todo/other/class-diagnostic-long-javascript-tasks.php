 ...
 */
class Diagnostic_Long_Javascript_Tasks extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Long Javascript Tasks
	 * Slug: -long-javascript-tasks
	 * File: class-diagnostic-long-javascript-tasks.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__long_javascript_tasks(): array {
		/*
