 ...
 */
class Diagnostic_Device_Specific_Performance extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Device Specific Performance
	 * Slug: -device-specific-performance
	 * File: class-diagnostic-device-specific-performance.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__device_specific_performance(): array {
		/*
