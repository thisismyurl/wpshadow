...
/**
 * Diagnostic: Source Map Exposure in Production (SEC-351)
 *
 * Detects exposed source maps increasing payload and risk.
 ...
 */
class Diagnostic_SourceMapExposure extends Diagnostic_Base {
	/**
	 ...
	 *
	 * Diagnostic: SourceMapExposure
	 * Slug: -source-map-exposure
	 * File: class-diagnostic-source-map-exposure.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__source_map_exposure(): array {
		/*
