 ...
 */
class Diagnostic_Table_Fragmentation extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Table Fragmentation
	 * Slug: -table-fragmentation
	 * File: class-diagnostic-table-fragmentation.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__table_fragmentation(): array {
		/*
