 ...
 */
class Diagnostic_Vary_Header_Misconfiguration extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Vary Header Misconfiguration
	 * Slug: -vary-header-misconfiguration
	 * File: class-diagnostic-vary-header-misconfiguration.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__vary_header_misconfiguration(): array {
		/*
