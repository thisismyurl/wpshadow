...
class Diagnostic_DiagnosticPerformanceAnomalyDetection extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: DiagnosticPerformanceAnomalyDetection
	 * Slug: -performance-anomaly-detection
	 * File: class-diagnostic-performance-anomaly-detection.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__performance_anomaly_detection(): array {
		/*
