...
class Diagnostic_Javascript_Sourcemaps_Production extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Javascript Sourcemaps Production
	 * Slug: -javascript-sourcemaps-production
	 * File: class-diagnostic-javascript-sourcemaps-production.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__javascript_sourcemaps_production(): array {
		/*
