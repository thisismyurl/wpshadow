 ...
 */
class Diagnostic_Row_Locking_Contention extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Row Locking Contention
	 * Slug: -row-locking-contention
	 * File: class-diagnostic-row-locking-contention.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__row_locking_contention(): array {
		/*
