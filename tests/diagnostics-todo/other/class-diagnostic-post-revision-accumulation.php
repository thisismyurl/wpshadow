...
class Diagnostic_Post_Revision_Accumulation extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Post Revision Accumulation
	 * Slug: -post-revision-accumulation
	 * File: class-diagnostic-post-revision-accumulation.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__post_revision_accumulation(): array {
		/*
