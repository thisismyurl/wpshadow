...
class Diagnostic_JavaScript_Error_Tracking extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: JavaScript Error Tracking
	 * Slug: -javascript-error-tracking
	 * File: class-diagnostic-javascript-error-tracking.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__javascript_error_tracking(): array {
		/*
