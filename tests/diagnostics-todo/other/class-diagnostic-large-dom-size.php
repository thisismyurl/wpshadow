 ...
 */
class Diagnostic_Large_Dom_Size extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Large Dom Size
	 * Slug: -large-dom-size
	 * File: class-diagnostic-large-dom-size.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__large_dom_size(): array {
		/*
