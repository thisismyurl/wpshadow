...
class Diagnostic_Core_File_Integrity extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Core File Integrity
	 * Slug: -core-file-integrity
	 * File: class-diagnostic-core-file-integrity.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__core_file_integrity(): array {
		/*
