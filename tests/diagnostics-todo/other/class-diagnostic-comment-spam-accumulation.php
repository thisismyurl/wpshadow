...
class Diagnostic_Comment_Spam_Accumulation extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Comment Spam Accumulation
	 * Slug: -comment-spam-accumulation
	 * File: class-diagnostic-comment-spam-accumulation.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__comment_spam_accumulation(): array {
		/*
