...
class Diagnostic_Design_DESIGN_NETWORK_FORM_CONSISTENCY extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design DESIGN NETWORK FORM CONSISTENCY
	 * Slug: -design-design-network-form-consistency
	 * File: class-diagnostic-design-design-network-form-consistency.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_design_network_form_consistency(): array {
		/*
