...
class Diagnostic_Design_DESIGN_FONT_FALLBACK_COVERAGE extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design DESIGN FONT FALLBACK COVERAGE
	 * Slug: -design-design-font-fallback-coverage
	 * File: class-diagnostic-design-design-font-fallback-coverage.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_design_font_fallback_coverage(): array {
		/*
