...
class Diagnostic_Design_DESIGN_NETWORK_SPACING_DRIFT extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design DESIGN NETWORK SPACING DRIFT
	 * Slug: -design-design-network-spacing-drift
	 * File: class-diagnostic-design-design-network-spacing-drift.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_design_network_spacing_drift(): array {
		/*
