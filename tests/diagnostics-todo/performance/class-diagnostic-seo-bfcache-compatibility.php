...
class Diagnostic_SEO_Bfcache_Compatibility extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: SEO Bfcache Compatibility
	 * Slug: -seo-bfcache-compatibility
	 * File: class-diagnostic-seo-bfcache-compatibility.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__seo_bfcache_compatibility(): array {
		/*
