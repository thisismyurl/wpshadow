...
class Diagnostic_Design_IMAGE_FORMAT_OPTIMIZATION extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design IMAGE FORMAT OPTIMIZATION
	 * Slug: -design-image-format-optimization
	 * File: class-diagnostic-design-image-format-optimization.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_image_format_optimization(): array {
		/*
