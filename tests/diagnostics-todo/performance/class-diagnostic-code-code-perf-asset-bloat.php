...
class Diagnostic_Code_CODE_PERF_ASSET_BLOAT extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Code CODE PERF ASSET BLOAT
	 * Slug: -code-code-perf-asset-bloat
	 * File: class-diagnostic-code-code-perf-asset-bloat.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__code_code_perf_asset_bloat(): array {
		/*
