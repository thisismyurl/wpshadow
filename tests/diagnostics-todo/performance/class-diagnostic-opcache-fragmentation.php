 ...
 */
class Diagnostic_OpcacheFragmentation extends Diagnostic_Base {
    /**
...
// Check if caching is properly configured
	 ...
	 *
	 * Diagnostic: OpcacheFragmentation
	 * Slug: -opcache-fragmentation
	 * File: class-diagnostic-opcache-fragmentation.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__opcache_fragmentation(): array {
		/*
