...
class Diagnostic_Design_DESIGN_NETWORK_WOO_TEMPLATE_DRIFT extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design DESIGN NETWORK WOO TEMPLATE DRIFT
	 * Slug: -design-design-network-woo-template-drift
	 * File: class-diagnostic-design-design-network-woo-template-drift.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_design_network_woo_template_drift(): array {
		/*
