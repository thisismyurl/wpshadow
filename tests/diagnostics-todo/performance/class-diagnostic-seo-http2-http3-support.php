...
class Diagnostic_SEO_HTTP2_HTTP3_Support extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: SEO HTTP2 HTTP3 Support
	 * Slug: -seo-http2-http3-support
	 * File: class-diagnostic-seo-http2-http3-support.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__seo_http2_http3_support(): array {
		/*
