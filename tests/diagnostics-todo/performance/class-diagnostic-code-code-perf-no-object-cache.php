...
class Diagnostic_Code_CODE_PERF_NO_OBJECT_CACHE extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Code CODE PERF NO OBJECT CACHE
	 * Slug: -code-code-perf-no-object-cache
	 * File: class-diagnostic-code-code-perf-no-object-cache.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__code_code_perf_no_object_cache(): array {
		/*
