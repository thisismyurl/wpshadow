...
class Diagnostic_Design_DESIGN_SPACING_SCALE_ADHERENCE extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design DESIGN SPACING SCALE ADHERENCE
	 * Slug: -design-design-spacing-scale-adherence
	 * File: class-diagnostic-design-design-spacing-scale-adherence.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_design_spacing_scale_adherence(): array {
		/*
