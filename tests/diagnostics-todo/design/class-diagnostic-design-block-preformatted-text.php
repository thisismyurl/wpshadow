...
class Diagnostic_Design_BLOCK_PREFORMATTED_TEXT extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design BLOCK PREFORMATTED TEXT
	 * Slug: -design-block-preformatted-text
	 * File: class-diagnostic-design-block-preformatted-text.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_block_preformatted_text(): array {
		/*
