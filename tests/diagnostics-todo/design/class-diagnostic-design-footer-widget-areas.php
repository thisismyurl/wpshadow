...
class Diagnostic_Design_FOOTER_WIDGET_AREAS extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design FOOTER WIDGET AREAS
	 * Slug: -design-footer-widget-areas
	 * File: class-diagnostic-design-footer-widget-areas.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_footer_widget_areas(): array {
		/*
