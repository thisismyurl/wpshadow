...
class Diagnostic_Design_DESIGN_VRT_FOOTER_CONSISTENCY extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design DESIGN VRT FOOTER CONSISTENCY
	 * Slug: -design-design-vrt-footer-consistency
	 * File: class-diagnostic-design-design-vrt-footer-consistency.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_design_vrt_footer_consistency(): array {
		/*
