...
class Diagnostic_Design_LOADING_STATE_DESIGN extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design LOADING STATE DESIGN
	 * Slug: -design-loading-state-design
	 * File: class-diagnostic-design-loading-state-design.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_loading_state_design(): array {
		/*
