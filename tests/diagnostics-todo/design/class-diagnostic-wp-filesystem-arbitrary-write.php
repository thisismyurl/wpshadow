...
class Diagnostic_WP_Filesystem_Arbitrary_Write extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: WP Filesystem Arbitrary Write
	 * Slug: -wp-filesystem-arbitrary-write
	 * File: class-diagnostic-wp-filesystem-arbitrary-write.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__wp_filesystem_arbitrary_write(): array {
		/*
