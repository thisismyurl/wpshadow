...
class Diagnostic_Monitor_Form extends Diagnostic_Base {
  public static function check(): ?array {
	 ...
	 * Slug: -monitor-form-field-reduction
	 * File: class-diagnostic-monitor-form-field-reduction.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__monitor_form_field_reduction(): array {
		/*
