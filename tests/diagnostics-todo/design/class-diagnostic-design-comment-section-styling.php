...
class Diagnostic_Design_COMMENT_SECTION_STYLING extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design COMMENT SECTION STYLING
	 * Slug: -design-comment-section-styling
	 * File: class-diagnostic-design-comment-section-styling.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_comment_section_styling(): array {
		/*
