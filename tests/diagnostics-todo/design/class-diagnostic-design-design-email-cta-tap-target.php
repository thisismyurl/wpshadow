...
class Diagnostic_Design_DESIGN_EMAIL_CTA_TAP_TARGET extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design DESIGN EMAIL CTA TAP TARGET
	 * Slug: -design-design-email-cta-tap-target
	 * File: class-diagnostic-design-design-email-cta-tap-target.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_design_email_cta_tap_target(): array {
		/*
