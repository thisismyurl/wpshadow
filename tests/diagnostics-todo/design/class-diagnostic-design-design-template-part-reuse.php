...
class Diagnostic_Design_DESIGN_TEMPLATE_PART_REUSE extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design DESIGN TEMPLATE PART REUSE
	 * Slug: -design-design-template-part-reuse
	 * File: class-diagnostic-design-design-template-part-reuse.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_design_template_part_reuse(): array {
		/*
