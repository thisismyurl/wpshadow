...
class Diagnostic_Design_GRID_GUTTER_CONSISTENCY extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design GRID GUTTER CONSISTENCY
	 * Slug: -design-grid-gutter-consistency
	 * File: class-diagnostic-design-grid-gutter-consistency.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_grid_gutter_consistency(): array {
		/*
