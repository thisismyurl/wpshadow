...
class Diagnostic_Design_DESIGN_UTILITIES_VS_COMPONENT_CONFLICT extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design DESIGN UTILITIES VS COMPONENT CONFLICT
	 * Slug: -design-design-utilities-vs-component-conflict
	 * File: class-diagnostic-design-design-utilities-vs-component-conflict.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_design_utilities_vs_component_conflict(): array {
		/*
