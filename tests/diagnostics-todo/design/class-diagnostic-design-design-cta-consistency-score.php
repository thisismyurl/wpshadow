...
class Diagnostic_Design_DESIGN_CTA_CONSISTENCY_SCORE extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design DESIGN CTA CONSISTENCY SCORE
	 * Slug: -design-design-cta-consistency-score
	 * File: class-diagnostic-design-design-cta-consistency-score.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_design_cta_consistency_score(): array {
		/*
