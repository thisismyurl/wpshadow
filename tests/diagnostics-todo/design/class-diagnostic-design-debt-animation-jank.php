...
class Diagnostic_Design_DEBT_ANIMATION_JANK extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design DEBT ANIMATION JANK
	 * Slug: -design-debt-animation-jank
	 * File: class-diagnostic-design-debt-animation-jank.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_debt_animation_jank(): array {
		/*
