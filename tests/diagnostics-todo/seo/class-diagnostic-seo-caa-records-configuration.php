...
class Diagnostic_SEO_CAA_Records_Configuration extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: SEO CAA Records Configuration
	 * Slug: -seo-caa-records-configuration
	 * File: class-diagnostic-seo-caa-records-configuration.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__seo_caa_records_configuration(): array {
		/*
