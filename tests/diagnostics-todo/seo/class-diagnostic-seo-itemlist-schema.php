...
class Diagnostic_SEO_ItemList_Schema extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: SEO ItemList Schema
	 * Slug: -seo-itemlist-schema
	 * File: class-diagnostic-seo-itemlist-schema.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__seo_itemlist_schema(): array {
		/*
