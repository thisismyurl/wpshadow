...
class Diagnostic_SEO_Opening_Hours_Schema extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: SEO Opening Hours Schema
	 * Slug: -seo-opening-hours-schema
	 * File: class-diagnostic-seo-opening-hours-schema.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__seo_opening_hours_schema(): array {
		/*
