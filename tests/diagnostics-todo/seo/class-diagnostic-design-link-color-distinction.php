...
class Diagnostic_Design_LINK_COLOR_DISTINCTION extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design LINK COLOR DISTINCTION
	 * Slug: -design-link-color-distinction
	 * File: class-diagnostic-design-link-color-distinction.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_link_color_distinction(): array {
		/*
