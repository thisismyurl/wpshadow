<?php
/**
 * Test for Envira Gallery Lightbox Security
 *
...
use WPShadow\Diagnostics\Diagnostic_EnviraGalleryLightboxSecurity;

/**
 * EnviraGalleryLightboxSecurityTest Class
 */
class EnviraGalleryLightboxSecurityTest extends TestCase {
	...
	public function test_diagnostic_class_exists() {
		$this->assertTrue( class_exists( 'WPShadow\Diagnostics\\Diagnostic_EnviraGalleryLightboxSecurity' ) );
	}

	public function test_check_method_is_callable() {
		$this->assertTrue( method_exists( 'WPShadow\Diagnostics\\Diagnostic_EnviraGalleryLightboxSecurity', 'check' ) );
		$this->assertTrue( is_callable( [ 'WPShadow\Diagnostics\\Diagnostic_EnviraGalleryLightboxSecurity', 'check' ] ) );
	}
	...
	public function test_returns_null_when_plugin_not_active() {
		...
		$result = Diagnostic_EnviraGalleryLightboxSecurity::check();
	...
	public function test_slug_property_matches_expected() {
		$reflection = new \ReflectionClass( 'WPShadow\Diagnostics\\Diagnostic_EnviraGalleryLightboxSecurity' );
		$property = $reflection->getProperty( 'slug' );
		$property->setAccessible( true );
		$slug = $property->getValue();
		
		$this->assertEquals( 'envira-gallery-lightbox-security', $slug );
	}
