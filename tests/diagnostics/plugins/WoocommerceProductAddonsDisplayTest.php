<?php
/**
 * Test for Woocommerce Product Addons Display
 *
...
use WPShadow\Diagnostics\Diagnostic_WoocommerceProductAddonsDisplay;

/**
 * WoocommerceProductAddonsDisplayTest Class
 */
class WoocommerceProductAddonsDisplayTest extends TestCase {
	...
	public function test_diagnostic_class_exists() {
		$this->assertTrue( class_exists( 'WPShadow\Diagnostics\\Diagnostic_WoocommerceProductAddonsDisplay' ) );
	}

	public function test_check_method_is_callable() {
		$this->assertTrue( method_exists( 'WPShadow\Diagnostics\\Diagnostic_WoocommerceProductAddonsDisplay', 'check' ) );
		$this->assertTrue( is_callable( [ 'WPShadow\Diagnostics\\Diagnostic_WoocommerceProductAddonsDisplay', 'check' ] ) );
	}
	...
	public function test_returns_null_when_plugin_not_active() {
		...
		$result = Diagnostic_WoocommerceProductAddonsDisplay::check();
	...
	public function test_slug_property_matches_expected() {
		$reflection = new \ReflectionClass( 'WPShadow\Diagnostics\\Diagnostic_WoocommerceProductAddonsDisplay' );
		$property = $reflection->getProperty( 'slug' );
		$property->setAccessible( true );
		$slug = $property->getValue();
		
		$this->assertEquals( 'woocommerce-product-addons-display', $slug );
	}
