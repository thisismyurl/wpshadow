<?php
/**
 * Test for Divi Builder Pro Theme Options Database
 *
...
use WPShadow\Diagnostics\Diagnostic_DiviBuilderProThemeOptionsDatabase;

/**
 * DiviBuilderProThemeOptionsDatabaseTest Class
 */
class DiviBuilderProThemeOptionsDatabaseTest extends TestCase {
	...
	public function test_diagnostic_class_exists() {
		$this->assertTrue( class_exists( 'WPShadow\Diagnostics\\Diagnostic_DiviBuilderProThemeOptionsDatabase' ) );
	}

	public function test_check_method_is_callable() {
		$this->assertTrue( method_exists( 'WPShadow\Diagnostics\\Diagnostic_DiviBuilderProThemeOptionsDatabase', 'check' ) );
		$this->assertTrue( is_callable( [ 'WPShadow\Diagnostics\\Diagnostic_DiviBuilderProThemeOptionsDatabase', 'check' ] ) );
	}
	...
	public function test_returns_null_when_plugin_not_active() {
		...
		$result = Diagnostic_DiviBuilderProThemeOptionsDatabase::check();
	...
	public function test_slug_property_matches_expected() {
		$reflection = new \ReflectionClass( 'WPShadow\Diagnostics\\Diagnostic_DiviBuilderProThemeOptionsDatabase' );
		$property = $reflection->getProperty( 'slug' );
		$property->setAccessible( true );
		$slug = $property->getValue();
		
		$this->assertEquals( 'divi-builder-pro-theme-options-database', $slug );
	}
