<?php
/**
 * Test for Google Analytics Enhanced Ecommerce
 *
...
use WPShadow\Diagnostics\Diagnostic_GoogleAnalyticsEnhancedEcommerce;

/**
 * GoogleAnalyticsEnhancedEcommerceTest Class
 */
class GoogleAnalyticsEnhancedEcommerceTest extends TestCase {
	...
	public function test_diagnostic_class_exists() {
		$this->assertTrue( class_exists( 'WPShadow\Diagnostics\\Diagnostic_GoogleAnalyticsEnhancedEcommerce' ) );
	}

	public function test_check_method_is_callable() {
		$this->assertTrue( method_exists( 'WPShadow\Diagnostics\\Diagnostic_GoogleAnalyticsEnhancedEcommerce', 'check' ) );
		$this->assertTrue( is_callable( [ 'WPShadow\Diagnostics\\Diagnostic_GoogleAnalyticsEnhancedEcommerce', 'check' ] ) );
	}
	...
	public function test_returns_null_when_plugin_not_active() {
		...
		$result = Diagnostic_GoogleAnalyticsEnhancedEcommerce::check();
	...
	public function test_slug_property_matches_expected() {
		$reflection = new \ReflectionClass( 'WPShadow\Diagnostics\\Diagnostic_GoogleAnalyticsEnhancedEcommerce' );
		$property = $reflection->getProperty( 'slug' );
		$property->setAccessible( true );
		$slug = $property->getValue();
		
		$this->assertEquals( 'google-analytics-enhanced-ecommerce', $slug );
	}
