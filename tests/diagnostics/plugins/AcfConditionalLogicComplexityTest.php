<?php
/**
 * Test for ACF Conditional Logic
 *
...
use WPShadow\Diagnostics\Diagnostic_AcfConditionalLogicComplexity;

/**
 * AcfConditionalLogicComplexityTest Class
 */
class AcfConditionalLogicComplexityTest extends TestCase {
	...
	public function test_diagnostic_class_exists() {
		$this->assertTrue( class_exists( 'WPShadow\Diagnostics\\Diagnostic_AcfConditionalLogicComplexity' ) );
	}

	public function test_check_method_is_callable() {
		$this->assertTrue( method_exists( 'WPShadow\Diagnostics\\Diagnostic_AcfConditionalLogicComplexity', 'check' ) );
		$this->assertTrue( is_callable( [ 'WPShadow\Diagnostics\\Diagnostic_AcfConditionalLogicComplexity', 'check' ] ) );
	}
	...
	public function test_returns_null_when_plugin_not_active() {
		...
		$result = Diagnostic_AcfConditionalLogicComplexity::check();
	...
	public function test_slug_property_matches_expected() {
		$reflection = new \ReflectionClass( 'WPShadow\Diagnostics\\Diagnostic_AcfConditionalLogicComplexity' );
		$property = $reflection->getProperty( 'slug' );
		$property->setAccessible( true );
		$slug = $property->getValue();
		
		$this->assertEquals( 'acf-conditional-logic-complexity', $slug );
	}
