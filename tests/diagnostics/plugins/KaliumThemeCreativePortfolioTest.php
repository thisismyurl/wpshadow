<?php
/**
 * Test for Kalium Theme Creative Portfolio
 *
...
use WPShadow\Diagnostics\Diagnostic_KaliumThemeCreativePortfolio;

/**
 * KaliumThemeCreativePortfolioTest Class
 */
class KaliumThemeCreativePortfolioTest extends TestCase {
	...
	public function test_diagnostic_class_exists() {
		$this->assertTrue( class_exists( 'WPShadow\Diagnostics\\Diagnostic_KaliumThemeCreativePortfolio' ) );
	}

	public function test_check_method_is_callable() {
		$this->assertTrue( method_exists( 'WPShadow\Diagnostics\\Diagnostic_KaliumThemeCreativePortfolio', 'check' ) );
		$this->assertTrue( is_callable( [ 'WPShadow\Diagnostics\\Diagnostic_KaliumThemeCreativePortfolio', 'check' ] ) );
	}

	public function test_returns_null_when_plugin_not_active() {
		// No specific plugin activation check
		
		$result = Diagnostic_KaliumThemeCreativePortfolio::check();
	...
	public function test_slug_property_matches_expected() {
		$reflection = new \ReflectionClass( 'WPShadow\Diagnostics\\Diagnostic_KaliumThemeCreativePortfolio' );
		$property = $reflection->getProperty( 'slug' );
		$property->setAccessible( true );
		$slug = $property->getValue();
		
		$this->assertEquals( 'kalium-theme-creative-portfolio', $slug );
	}
