<?php
/**
 * Test for Woocommerce Composite Products Inventory
 *
...
use WPShadow\Diagnostics\Diagnostic_WoocommerceCompositeProductsInventory;

/**
 * WoocommerceCompositeProductsInventoryTest Class
 */
class WoocommerceCompositeProductsInventoryTest extends TestCase {
	...
	public function test_diagnostic_class_exists() {
		$this->assertTrue( class_exists( 'WPShadow\Diagnostics\\Diagnostic_WoocommerceCompositeProductsInventory' ) );
	}

	public function test_check_method_is_callable() {
		$this->assertTrue( method_exists( 'WPShadow\Diagnostics\\Diagnostic_WoocommerceCompositeProductsInventory', 'check' ) );
		$this->assertTrue( is_callable( [ 'WPShadow\Diagnostics\\Diagnostic_WoocommerceCompositeProductsInventory', 'check' ] ) );
	}
	...
	public function test_returns_null_when_plugin_not_active() {
		...
		$result = Diagnostic_WoocommerceCompositeProductsInventory::check();
	...
	public function test_slug_property_matches_expected() {
		$reflection = new \ReflectionClass( 'WPShadow\Diagnostics\\Diagnostic_WoocommerceCompositeProductsInventory' );
		$property = $reflection->getProperty( 'slug' );
		$property->setAccessible( true );
		$slug = $property->getValue();
		
		$this->assertEquals( 'woocommerce-composite-products-inventory', $slug );
	}
