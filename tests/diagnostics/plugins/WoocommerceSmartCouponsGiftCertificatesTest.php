<?php
/**
 * Test for Woocommerce Smart Coupons Gift Certificates
 *
...
use WPShadow\Diagnostics\Diagnostic_WoocommerceSmartCouponsGiftCertificates;

/**
 * WoocommerceSmartCouponsGiftCertificatesTest Class
 */
class WoocommerceSmartCouponsGiftCertificatesTest extends TestCase {
	...
	public function test_diagnostic_class_exists() {
		$this->assertTrue( class_exists( 'WPShadow\Diagnostics\\Diagnostic_WoocommerceSmartCouponsGiftCertificates' ) );
	}

	public function test_check_method_is_callable() {
		$this->assertTrue( method_exists( 'WPShadow\Diagnostics\\Diagnostic_WoocommerceSmartCouponsGiftCertificates', 'check' ) );
		$this->assertTrue( is_callable( [ 'WPShadow\Diagnostics\\Diagnostic_WoocommerceSmartCouponsGiftCertificates', 'check' ] ) );
	}
	...
	public function test_returns_null_when_plugin_not_active() {
		...
		$result = Diagnostic_WoocommerceSmartCouponsGiftCertificates::check();
	...
	public function test_slug_property_matches_expected() {
		$reflection = new \ReflectionClass( 'WPShadow\Diagnostics\\Diagnostic_WoocommerceSmartCouponsGiftCertificates' );
		$property = $reflection->getProperty( 'slug' );
		$property->setAccessible( true );
		$slug = $property->getValue();
		
		$this->assertEquals( 'woocommerce-smart-coupons-gift-certificates', $slug );
	}
