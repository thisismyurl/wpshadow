<?php
/**
 * Test for SearchWP Custom Field Indexing
 *
...
use WPShadow\Diagnostics\Diagnostic_SearchwpCustomFieldIndexing;

/**
 * SearchwpCustomFieldIndexingTest Class
 */
class SearchwpCustomFieldIndexingTest extends TestCase {
	...
	public function test_diagnostic_class_exists() {
		$this->assertTrue( class_exists( 'WPShadow\Diagnostics\\Diagnostic_SearchwpCustomFieldIndexing' ) );
	}

	public function test_check_method_is_callable() {
		$this->assertTrue( method_exists( 'WPShadow\Diagnostics\\Diagnostic_SearchwpCustomFieldIndexing', 'check' ) );
		$this->assertTrue( is_callable( [ 'WPShadow\Diagnostics\\Diagnostic_SearchwpCustomFieldIndexing', 'check' ] ) );
	}
	...
	public function test_returns_null_when_plugin_not_active() {
		...
		$result = Diagnostic_SearchwpCustomFieldIndexing::check();
	...
	public function test_slug_property_matches_expected() {
		$reflection = new \ReflectionClass( 'WPShadow\Diagnostics\\Diagnostic_SearchwpCustomFieldIndexing' );
		$property = $reflection->getProperty( 'slug' );
		$property->setAccessible( true );
		$slug = $property->getValue();
		
		$this->assertEquals( 'searchwp-custom-field-indexing', $slug );
	}
