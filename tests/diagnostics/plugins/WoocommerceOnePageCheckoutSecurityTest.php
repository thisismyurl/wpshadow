<?php
/**
 * Test for Woocommerce One Page Checkout Security
 *
...
use WPShadow\Diagnostics\Diagnostic_WoocommerceOnePageCheckoutSecurity;

/**
 * WoocommerceOnePageCheckoutSecurityTest Class
 */
class WoocommerceOnePageCheckoutSecurityTest extends TestCase {
	...
	public function test_diagnostic_class_exists() {
		$this->assertTrue( class_exists( 'WPShadow\Diagnostics\\Diagnostic_WoocommerceOnePageCheckoutSecurity' ) );
	}

	public function test_check_method_is_callable() {
		$this->assertTrue( method_exists( 'WPShadow\Diagnostics\\Diagnostic_WoocommerceOnePageCheckoutSecurity', 'check' ) );
		$this->assertTrue( is_callable( [ 'WPShadow\Diagnostics\\Diagnostic_WoocommerceOnePageCheckoutSecurity', 'check' ] ) );
	}
	...
	public function test_returns_null_when_plugin_not_active() {
		...
		$result = Diagnostic_WoocommerceOnePageCheckoutSecurity::check();
	...
	public function test_slug_property_matches_expected() {
		$reflection = new \ReflectionClass( 'WPShadow\Diagnostics\\Diagnostic_WoocommerceOnePageCheckoutSecurity' );
		$property = $reflection->getProperty( 'slug' );
		$property->setAccessible( true );
		$slug = $property->getValue();
		
		$this->assertEquals( 'woocommerce-one-page-checkout-security', $slug );
	}
