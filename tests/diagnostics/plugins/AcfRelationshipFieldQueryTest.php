<?php
/**
 * Test for ACF Relationship Field Query
 *
...
use WPShadow\Diagnostics\Diagnostic_AcfRelationshipFieldQuery;

/**
 * AcfRelationshipFieldQueryTest Class
 */
class AcfRelationshipFieldQueryTest extends TestCase {
	...
	public function test_diagnostic_class_exists() {
		$this->assertTrue( class_exists( 'WPShadow\Diagnostics\\Diagnostic_AcfRelationshipFieldQuery' ) );
	}

	public function test_check_method_is_callable() {
		$this->assertTrue( method_exists( 'WPShadow\Diagnostics\\Diagnostic_AcfRelationshipFieldQuery', 'check' ) );
		$this->assertTrue( is_callable( [ 'WPShadow\Diagnostics\\Diagnostic_AcfRelationshipFieldQuery', 'check' ] ) );
	}
	...
	public function test_returns_null_when_plugin_not_active() {
		...
		$result = Diagnostic_AcfRelationshipFieldQuery::check();
	...
	public function test_slug_property_matches_expected() {
		$reflection = new \ReflectionClass( 'WPShadow\Diagnostics\\Diagnostic_AcfRelationshipFieldQuery' );
		$property = $reflection->getProperty( 'slug' );
		$property->setAccessible( true );
		$slug = $property->getValue();
		
		$this->assertEquals( 'acf-relationship-field-query', $slug );
	}
