<?php
/**
 * Test for ACF Conditional Logic Performance
 *
...
use WPShadow\Diagnostics\Diagnostic_AcfConditionalLogicPerformance;

/**
 * AcfConditionalLogicPerformanceTest Class
 */
class AcfConditionalLogicPerformanceTest extends TestCase {
	...
	public function test_diagnostic_class_exists() {
		$this->assertTrue( class_exists( 'WPShadow\Diagnostics\\Diagnostic_AcfConditionalLogicPerformance' ) );
	}

	public function test_check_method_is_callable() {
		$this->assertTrue( method_exists( 'WPShadow\Diagnostics\\Diagnostic_AcfConditionalLogicPerformance', 'check' ) );
		$this->assertTrue( is_callable( [ 'WPShadow\Diagnostics\\Diagnostic_AcfConditionalLogicPerformance', 'check' ] ) );
	}
	...
	public function test_returns_null_when_plugin_not_active() {
		...
		$result = Diagnostic_AcfConditionalLogicPerformance::check();
	...
	public function test_slug_property_matches_expected() {
		$reflection = new \ReflectionClass( 'WPShadow\Diagnostics\\Diagnostic_AcfConditionalLogicPerformance' );
		$property = $reflection->getProperty( 'slug' );
		$property->setAccessible( true );
		$slug = $property->getValue();
		
		$this->assertEquals( 'acf-conditional-logic-performance', $slug );
	}
