<?php
/**
 * Test for Divi Builder jQuery Dependency
 *
...
use WPShadow\Diagnostics\Diagnostic_DiviBuilderJqueryDependency;

/**
 * DiviBuilderJqueryDependencyTest Class
 */
class DiviBuilderJqueryDependencyTest extends TestCase {
	...
	public function test_diagnostic_class_exists() {
		$this->assertTrue( class_exists( 'WPShadow\Diagnostics\\Diagnostic_DiviBuilderJqueryDependency' ) );
	}

	public function test_check_method_is_callable() {
		$this->assertTrue( method_exists( 'WPShadow\Diagnostics\\Diagnostic_DiviBuilderJqueryDependency', 'check' ) );
		$this->assertTrue( is_callable( [ 'WPShadow\Diagnostics\\Diagnostic_DiviBuilderJqueryDependency', 'check' ] ) );
	}
	...
	public function test_returns_null_when_plugin_not_active() {
		...
		$result = Diagnostic_DiviBuilderJqueryDependency::check();
	...
	public function test_slug_property_matches_expected() {
		$reflection = new \ReflectionClass( 'WPShadow\Diagnostics\\Diagnostic_DiviBuilderJqueryDependency' );
		$property = $reflection->getProperty( 'slug' );
		$property->setAccessible( true );
		$slug = $property->getValue();
		
		$this->assertEquals( 'divi-builder-jquery-dependency', $slug );
	}
