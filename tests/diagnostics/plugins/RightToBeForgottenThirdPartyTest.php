<?php
/**
 * Test for Right To Be Forgotten Third Party
 *
...
use WPShadow\Diagnostics\Diagnostic_RightToBeForgottenThirdParty;

/**
 * RightToBeForgottenThirdPartyTest Class
 */
class RightToBeForgottenThirdPartyTest extends TestCase {
	...
	public function test_diagnostic_class_exists() {
		$this->assertTrue( class_exists( 'WPShadow\Diagnostics\\Diagnostic_RightToBeForgottenThirdParty' ) );
	}

	public function test_check_method_is_callable() {
		$this->assertTrue( method_exists( 'WPShadow\Diagnostics\\Diagnostic_RightToBeForgottenThirdParty', 'check' ) );
		$this->assertTrue( is_callable( [ 'WPShadow\Diagnostics\\Diagnostic_RightToBeForgottenThirdParty', 'check' ] ) );
	}

	public function test_returns_null_when_plugin_not_active() {
		// No specific plugin activation check
		
		$result = Diagnostic_RightToBeForgottenThirdParty::check();
	...
	public function test_slug_property_matches_expected() {
		$reflection = new \ReflectionClass( 'WPShadow\Diagnostics\\Diagnostic_RightToBeForgottenThirdParty' );
		$property = $reflection->getProperty( 'slug' );
		$property->setAccessible( true );
		$slug = $property->getValue();
		
		$this->assertEquals( 'right-to-be-forgotten-third-party', $slug );
	}
