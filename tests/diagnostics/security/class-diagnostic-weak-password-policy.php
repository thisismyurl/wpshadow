...
class Diagnostic_Weak_Password_Policy extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Weak Password Policy Detection
	 ...
	 * - Description: Analyzes site-wide password strength without storing passwords.
	 *
	 * @return array {
	 ...
	 * }
	 */
	public static function test_live_weak_password_policy(): array {
		/*
