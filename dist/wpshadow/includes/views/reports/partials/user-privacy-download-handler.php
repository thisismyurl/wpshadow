...
if ( ! function_exists( 'wpshadow_handle_user_privacy_download' ) ) {
	 ...
	 * @return void
	 */
	function wpshadow_handle_user_privacy_download() {
		...
		if ( 'pdf' === $download_type ) {
			...
			$pdf_html = '<h1>' . esc_html__( 'WPShadow User Privacy Report', 'wpshadow' ) . '</h1>';
			...
			$pdf_html .= '<p><strong>' . esc_html__( 'User ID', 'wpshadow' ) . ':</strong> ' . esc_html( (string) $target_user_id ) . '</p>';
			$pdf_html .= '<p><strong>' . esc_html__( 'User', 'wpshadow' ) . ':</strong> ' . esc_html( (string) ( $summary['user_label'] ?? '' ) ) . '</p>';
			$pdf_html .= '<ul>';
			$pdf_html .= '<li>' . esc_html__( 'Settings count', 'wpshadow' ) . ': ' . esc_html( (string) ( $summary['settings_count'] ?? 0 ) ) . '</li>';
			$pdf_html .= '<li>' . esc_html__( 'User meta count', 'wpshadow' ) . ': ' . esc_html( (string) ( $summary['user_meta_count'] ?? 0 ) ) . '</li>';
			$pdf_html .= '<li>' . esc_html__( 'Activity log count', 'wpshadow' ) . ': ' . esc_html( (string) ( $summary['activity_log_count'] ?? 0 ) ) . '</li>';
			$pdf_html .= '<li>' . esc_html__( 'Consent', 'wpshadow' ) . ': ' . esc_html( ! empty( $consent['anonymized_telemetry'] ) ? __( 'Anonymous usage data enabled', 'wpshadow' ) : __( 'Anonymous usage data disabled', 'wpshadow' ) ) . '</li>';
			$pdf_html .= '</ul>';
