<?php
/**
 * Admin Redirect Security After Login Treatment
 *
...
/**
 * Treatment: Admin Redirect Security After Login
 *
...
class Treatment_Admin_Redirect_Security_After_Login extends Treatment_Base {
	...
	public static function check() {
		return self::proxy_diagnostic_check( '\WPShadow\Diagnostics\Diagnostic_Admin_Redirect_Security_After_Login' );
	}
}
