<?php
/**
 * Comment URL Validation Treatment
 *
...
/**
 * Comment URL Validation Treatment Class\n *
 ...
 * @since 0.6093.1200
 */
class Treatment_Comment_URL_Validation extends Treatment_Base {
	...
	public static function check() {
		return self::proxy_diagnostic_check( '\\WPShadow\\Diagnostics\\Diagnostic_Comment_URL_Validation' );
	}
}
