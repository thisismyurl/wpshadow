...
related_articles:
  - "[related-article-1]"
  - "[related-article-2]"
wp_link: "https://wpshadow.com/kb/dashboard-widget-bloat"
course_link: "https://academy.wpshadow.com/courses/performance-optimization"
course_name: "performance-optimization"
---

# Dashboard Widget Bloat

> **Read on WPShadow:** For the latest version and community discussion, [visit this article on WPShadow.com →](https://wpshadow.com/kb/dashboard-widget-bloat)
...
3. **Find "Dashboard Widget Bloat"** → Shows the issue
...
Found an issue with this article? [**Edit on GitHub** →](https://github.com/thisismyurl/wpshadow/blob/main/kb-articles/performance/dashboard-widget-bloat.md)
