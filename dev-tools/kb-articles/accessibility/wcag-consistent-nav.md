---
title: "WCAG Consistent Navigation"
description: "[Brief description of what this article covers and why it matters]"
category: "accessibility"
tags: ["wordpress", "accessibility", "wcag-consistent-nav"]
...
related_articles:
  - "[related-article-1]"
  - "[related-article-2]"
wp_link: "https://wpshadow.com/kb/wcag-consistent-nav"
...
> **Read on WPShadow:** For the latest version and community discussion, [visit this article on WPShadow.com →](https://wpshadow.com/kb/wcag-consistent-nav)
...
3. **Find "WCAG Consistent Navigation"** → Shows the issue
...
Found an issue with this article? [**Edit on GitHub** →](https://github.com/thisismyurl/wpshadow/blob/main/kb-articles/accessibility/wcag-consistent-nav.md)
