...
category: "security"
tags: ["wordpress", "security", "unlicensed-images"]
...
related_articles:
  - "[related-article-1]"
  - "[related-article-2]"
wp_link: "https://wpshadow.com/kb/unlicensed-images"
...
> **Read on WPShadow:** For the latest version and community discussion, [visit this article on WPShadow.com →](https://wpshadow.com/kb/unlicensed-images)
...
3. **Find "Unlicensed Images"** → Shows the issue
...
Found an issue with this article? [**Edit on GitHub** →](https://github.com/thisismyurl/wpshadow/blob/main/kb-articles/security/unlicensed-images.md)
