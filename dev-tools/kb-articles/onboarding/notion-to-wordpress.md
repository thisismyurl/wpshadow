...
category: "onboarding"
tags: ["wordpress", "onboarding", "notion-to-wordpress"]
...
related_articles:
  - "[related-article-1]"
  - "[related-article-2]"
wp_link: "https://wpshadow.com/kb/notion-to-wordpress"
...
> **Read on WPShadow:** For the latest version and community discussion, [visit this article on WPShadow.com →](https://wpshadow.com/kb/notion-to-wordpress)
...
3. **Find "Notion to WordPress"** → Shows the issue
...
Found an issue with this article? [**Edit on GitHub** →](https://github.com/thisismyurl/wpshadow/blob/main/kb-articles/onboarding/notion-to-wordpress.md)
