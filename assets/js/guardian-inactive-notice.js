jQuery( document ).ready( function( $ ) {
	$( '#wpshadow-guardian-notice' ).on( 'click', '#wpshadow-activate-guardian-btn', function( event ) {
	...
	$( '#wpshadow-guardian-notice' ).on( 'click', '.notice-dismiss, #wpshadow-dismiss-guardian-notice', function( event ) {
