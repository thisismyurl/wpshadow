...
(function() {
	...
	function registerAllBlockStyles() {
		...
		registerBlockStyle('wpshadow/testimonials', {
			name: 'card',
		...
		registerBlockStyle('wpshadow/team-members', {
			name: 'card',
			label: __('Card Style', 'wpshadow'),
			isDefault: true
		});
		...
		registerBlockStyle('wpshadow/portfolio', {
			name: 'grid',
		...
		// Events Block Styles
		registerBlockStyle('wpshadow/events', {
			name: 'list',
		...
		registerBlockStyle('wpshadow/resources', {
			name: 'card',
			label: __('Card Style', 'wpshadow'),
			isDefault: true
		});
		...
		registerBlockStyle('wpshadow/case-studies', {
			name: 'default',
		...
		registerBlockStyle('wpshadow/services', {
			name: 'card',
			label: __('Card Style', 'wpshadow'),
			isDefault: true
		});
		...
		registerBlockStyle('wpshadow/locations', {
			name: 'list',
			label: __('List Style', 'wpshadow'),
			isDefault: true
		});
		...
		registerBlockStyle('wpshadow/documentation', {
			name: 'default',
			label: __('Default', 'wpshadow'),
			isDefault: true
		});
