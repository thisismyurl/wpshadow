...
(function($) {
    ...
    const WPShadowReportBuilder = {
        ...
        initPresetButtons: function() {
            ...
            $(document).on('click', '.wps-preset-btn', function(e) {
                e.preventDefault();
        ...
        initReportTypeSelection: function() {
            ...
            $(document).on('click', '.wps-report-type-option', function(e) {
                e.preventDefault();
    ...
    const WPShadowReportDisplay = {
        ...
        initEmailReport: function() {
            ...
            $(document).on('click', '[data-action="email-report"]', function(e) {
                e.preventDefault();
                WPShadowAdmin.openModal('email-report-modal');
            });

            $(document).on('submit', '#email-report-form', function(e) {
                e.preventDefault();
        ...
        initPrintButton: function() {
            $(document).on('click', '[data-action="print-report"]', function(e) {
                e.preventDefault();
                window.print();
            });
        },
        ...
        initShareOptions: function() {
            ...
            $(document).on('click', '[data-share-platform]', function(e) {
                e.preventDefault();
