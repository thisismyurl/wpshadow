...
class Bot_Traffic_Analyzer {
    ...
    public static function track_request(): void {
        ...
        $requests = array_filter($requests, function($item) use ($one_day_ago) {
    ...
    public static function analyze(): array {
        ...
        // Count by bot type
        $bot_counts = array('good' => 0, 'bad' => 0, 'unknown' => 0);
        $by_user_agent = array();
        $by_ip = array();
        ...
        foreach ($data as $request) {
            ...
            if (!isset($by_user_agent[$ua])) {
                $by_user_agent[$ua] = array('count' => 0, 'type' => $type);
            }
        ...
        // Top bots
        uasort($by_user_agent, function($a, $b) {
