<?php
/**
 * Comment Status Inconsistencies Treatment
 *
...
/**
 * Comment Status Inconsistencies Treatment Class
 *
...
class Treatment_Comment_Status_Inconsistencies extends Treatment_Base {
	...
	public static function check() {
		return self::proxy_diagnostic_check( '\WPShadow\Diagnostics\Diagnostic_Comment_Status_Inconsistencies' );
	}
}
