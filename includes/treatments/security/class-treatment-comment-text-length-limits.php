<?php
/**
 * Comment Text Length Limits Treatment
 *
...
/**
 * Comment Text Length Treatment Class\n *
 ...
 * @since 1.6031.1300
 */
class Treatment_Comment_Text_Length_Limits extends Treatment_Base {
	...
	public static function check() {
		return self::proxy_diagnostic_check( '\\WPShadow\\Diagnostics\\Diagnostic_Comment_Text_Length_Limits' );
	}
}
