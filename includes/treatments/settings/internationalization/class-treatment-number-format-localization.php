		...
		if ( ! empty( $issues ) ) {
			return array(
				...
				'details'      => array(
					...
					'global_formats'        => 'US: 1,000.50 | Europe: 1.000,50 | India: 1,00,000.50',
