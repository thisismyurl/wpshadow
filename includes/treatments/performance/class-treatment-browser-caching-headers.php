 ...
 *
 * **Why This Matters:**
 * Without proper caching headers, browsers re-download the same CSS/JS/images on every visit.\n * A typical site loads 200 assets (1.5MB total). On the first visit,1.0MB downloads. Without caching,
 * a repeat visitor within 1 hour downloads1.0MB again. With proper Cache-Control: max-age=31536000,
