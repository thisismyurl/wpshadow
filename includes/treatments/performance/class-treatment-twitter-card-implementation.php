...
class Treatment_Twitter_Card_Implementation extends Treatment_Base {
	...
	public static function check() {
		...
		$homepage_content = Treatment_HTML_Helper::fetch_html( home_url() );
		...
		if ( ! Treatment_URL_And_Pattern_Helper::has_meta_tag( $homepage_content, Treatment_URL_And_Pattern_Helper::PATTERN_TWITTER_CARD ) ) {
			return array(
				'id'           => self::$slug,
				'title'        => self::$title,
		...
		if ( ! Treatment_URL_And_Pattern_Helper::has_meta_tag( $homepage_content, Treatment_URL_And_Pattern_Helper::PATTERN_TWITTER_CREATOR ) && 
			 ! Treatment_URL_And_Pattern_Helper::has_meta_tag( $homepage_content, Treatment_URL_And_Pattern_Helper::PATTERN_TWITTER_CREATOR ) ) {
			return array(
				'id'           => self::$slug,
				'title'        => self::$title,
		...
		if ( Treatment_URL_And_Pattern_Helper::has_meta_tag( $homepage_content, Treatment_URL_And_Pattern_Helper::PATTERN_TWITTER_IMAGE ) ) {
			// Check for image width/height specifications
				if ( ! Treatment_URL_And_Pattern_Helper::has_meta_tag( $homepage_content, Treatment_URL_And_Pattern_Helper::PATTERN_TWITTER_IMAGE_DIMENSIONS ) ) {
				return array(
					'id'           => self::$slug,
					'title'        => self::$title,
		...
		if ( ! Treatment_URL_And_Pattern_Helper::has_meta_tag( $homepage_content, Treatment_URL_And_Pattern_Helper::PATTERN_TWITTER_IMAGE_ALT ) ) {
			return array(
				'id'           => self::$slug,
				'title'        => self::$title,
		...
		if ( ! Treatment_URL_And_Pattern_Helper::has_meta_tag( $homepage_content, Treatment_URL_And_Pattern_Helper::PATTERN_TWITTER_DESCRIPTION ) ) {
			return array(
				'id'           => self::$slug,
				'title'        => self::$title,
