...
class TIMU_Feature_Registry {
	...
	public static function init(): void {
		...
		add_action( 'timu_register_features', array( __CLASS__, 'discover_features' ), 10, 0 );
	}
	 ...
	 *
	 * Example:
	 *   register_timu_feature( 'license_management', array(
	...
	public static function discover_features(): void {
		...
		do_action( 'timu_register_features' );
	}
}
