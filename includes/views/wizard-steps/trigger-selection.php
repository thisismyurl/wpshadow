...
<div class="wizard-step trigger-selection">
	<h2><?php esc_html_e( 'If This Happens...', 'wpshadow' ); ?></h2>
	<p class="description">
...
jQuery(document).ready(function($) {
	$('.trigger-option').on('click', function() {
		...
		window.location.href = '<?php echo admin_url( 'admin.php?page=wpshadow-automation&action=create&step=trigger-config' ); ?>&trigger=' + triggerId;
	});
});
</script>
