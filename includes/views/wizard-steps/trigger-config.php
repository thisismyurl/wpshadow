...
<div class="wizard-step trigger-config">
	<div class="step-header">
		<a href="<?php echo esc_url( admin_url( 'admin.php?page=wpshadow-automation&action=create&step=trigger' ) ); ?>" class="back-button">
	...
	<?php else : ?>
		...
		<div class="no-config-message">
			<p><?php esc_html_e( 'This trigger doesn\'t need any additional configuration.', 'wpshadow' ); ?></p>
			<a href="<?php echo esc_url( admin_url( 'admin.php?page=wpshadow-automation&action=create&step=action&trigger=' . $trigger_id ) ); ?>" class="button button-primary button-large">
				<?php esc_html_e( 'Continue to Actions', 'wpshadow' ); ?>
				<span class="dashicons dashicons-arrow-right-alt2"></span>
			</a>
		</div>
