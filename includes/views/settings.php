...
$action_url      = $is_network ? network_admin_url( 'admin.php?page=timu-core-network-settings' ) : admin_url( 'admin.php?page=wp-support&timu_tab=settings' );
...
<div class="wrap timu-core-wrap">
	...
	<div class="timu-license-card" style="margin-top:10px; padding:16px; background:#fff; border:1px solid #ccd0d4;">
		...
		<p class="description"><?php echo esc_html__( 'Applies across all TIMU hub and spoke plugins on this site.', 'plugin-wp-support-thisismyurl' ); ?></p>
		<p>
		...
		<form method="post" action="<?php echo esc_url( $action_url ); ?>">
			...
			<table class="form-table" role="presentation">
				<tr>
					<th scope="row"><label for="timu_license_key"><?php echo esc_html__( 'Registration Key', 'plugin-wp-support-thisismyurl' ); ?></label></th>
					<td>
		...
		<div class="timu-broadcast-card" style="margin-top:16px; padding:16px; background:#fff; border:1px solid #ccd0d4;">
			...
			<?php if ( ! empty( $license_state['key'] ) && 'valid' === $license_status ) : ?>
				<form method="post" action="<?php echo esc_url( $action_url ); ?>" class="timu-broadcast-form">
					...
					<?php submit_button( esc_html__( 'Broadcast License to Selected Sites', 'plugin-wp-support-thisismyurl' ), 'primary', 'submit', false, 'id="timu-broadcast-btn"' ); ?>
				</form>
	...
	<form method="post" action="<?php echo esc_url( $action_url ); ?>">
		...
		<table class="form-table" role="presentation">
			<tr>
				<th scope="row">
					<label for="timu_vault_encrypt"><?php echo esc_html__( 'Enable Encryption (AES-256-GCM)', 'plugin-wp-support-thisismyurl' ); ?></label>
				</th>
				<td>
					<label>
			...
			<tr>
				<th scope="row">
					<label for="timu_vault_enabled"><?php echo esc_html__( 'Enable Vault Ingest', 'plugin-wp-support-thisismyurl' ); ?></label>
				</th>
				<td>
					<label>
			...
			<tr>
				<th scope="row">
					<label for="timu_vault_download_ttl"><?php echo esc_html__( 'Download Link TTL (seconds)', 'plugin-wp-support-thisismyurl' ); ?></label>
				</th>
				<td>
			...
			<tr>
				<th scope="row">
					<label for="timu_vault_allow_override"><?php echo esc_html__( 'Allow Site Overrides', 'plugin-wp-support-thisismyurl' ); ?></label>
				</th>
				<td>
					<label>
		...
		<table class="form-table" role="presentation">
			<tr>
				<th scope="row"><label for="timu_vault_max_size_mb"><?php echo esc_html__( 'Max Vault Size (MB)', 'plugin-wp-support-thisismyurl' ); ?></label></th>
				<td>
			...
			<tr>
				<th scope="row"><label for="timu_vault_alert_email"><?php echo esc_html__( 'Alert Email', 'plugin-wp-support-thisismyurl' ); ?></label></th>
				<td>
			...
			<tr>
				<th scope="row"><label for="timu_vault_mirror_logs"><?php echo esc_html__( 'Mirror Logs to Disk', 'plugin-wp-support-thisismyurl' ); ?></label></th>
				<td>
					<label>
		...
		<table class="form-table" role="presentation">
			<tr>
				<th scope="row"><label for="timu_vault_offload_enabled"><?php echo esc_html__( 'Enable Offload', 'plugin-wp-support-thisismyurl' ); ?></label></th>
				<td>
					<label>
			...
			<tr>
				<th scope="row"><label for="timu_gdrive_client_id"><?php echo esc_html__( 'Google Client ID', 'plugin-wp-support-thisismyurl' ); ?></label></th>
				<td>
			...
			<tr>
				<th scope="row"><label for="timu_gdrive_client_secret"><?php echo esc_html__( 'Google Client Secret', 'plugin-wp-support-thisismyurl' ); ?></label></th>
				<td>
		...
		<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
			...
			<table class="form-table" role="presentation">
				<tr>
					<th scope="row"><label for="timu_gdrive_folder"><?php echo esc_html__( 'Folder Name', 'plugin-wp-support-thisismyurl' ); ?></label></th>
					<td>
						<input type="text" name="timu_gdrive_folder" id="timu_gdrive_folder" value="TIMU Vault" class="regular-text" />
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="timu_gdrive_count"><?php echo esc_html__( 'Number of Files', 'plugin-wp-support-thisismyurl' ); ?></label></th>
					<td>
						<input type="number" name="timu_gdrive_count" id="timu_gdrive_count" min="1" max="100" value="10" />
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="timu_gdrive_delete_local"><?php echo esc_html__( 'Delete Local After Upload', 'plugin-wp-support-thisismyurl' ); ?></label></th>
					<td>
						<label>
	...
	<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
		...
		<p>
			<button class="button" type="submit" name="timu_vault_key_cmd" value="rotate" onclick="return confirm( '<?php echo esc_attr__( 'Rotate the encryption key? New items will use the new key.', 'plugin-wp-support-thisismyurl' ); ?>' );"><?php echo esc_html__( 'Rotate Key', 'plugin-wp-support-thisismyurl' ); ?></button>
		...
		<p>
			<button class="button" type="submit" name="timu_vault_key_cmd" value="reencrypt_sample" onclick="return confirm( '<?php echo esc_attr__( 'Re-encrypt a recent sample (25 items)?', 'plugin-wp-support-thisismyurl' ); ?>' );"><?php echo esc_html__( 'Re-encrypt Recent Sample (25)', 'plugin-wp-support-thisismyurl' ); ?></button>
	...
	<form method="post" action="<?php echo esc_url( $action_url ); ?>">
		...
		<input type="hidden" name="page" value="<?php echo $is_network ? 'timu-core-network-settings' : 'wp-support'; ?>" />
		<p>
			<button class="button" type="submit" name="timu_vault_tool_action" value="rehydrate_missing"><?php echo esc_html__( 'Rehydrate missing attachments (up to 25)', 'plugin-wp-support-thisismyurl' ); ?></button>
		...
		<p>
			<button class="button" type="submit" name="timu_vault_tool_action" value="verify_sample"><?php echo esc_html__( 'Verify Vault integrity (sample 10)', 'plugin-wp-support-thisismyurl' ); ?></button>
	...
	<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
		...
		<p>
			<button class="button" type="submit" name="timu_vault_queue_cmd" value="start_rehydrate"><?php echo esc_html__( 'Start bulk rehydrate', 'plugin-wp-support-thisismyurl' ); ?></button>
		...
		<p>
			<button class="button" type="submit" name="timu_vault_queue_cmd" value="start_verify"><?php echo esc_html__( 'Start bulk verify', 'plugin-wp-support-thisismyurl' ); ?></button>
		...
		<p>
			<button class="button" type="submit" name="timu_vault_queue_cmd" value="start_reencrypt"><?php echo esc_html__( 'Start bulk re-encrypt', 'plugin-wp-support-thisismyurl' ); ?></button>
		...
		<p>			<button class="button button-primary" type="submit" name="timu_vault_queue_cmd" value="start_migrate"><?php echo esc_html__( 'Start bulk migrate', 'plugin-wp-support-thisismyurl' ); ?></button>
		...
		<p>
			<button class="button" type="submit" name="timu_vault_queue_cmd" value="stop"><?php echo esc_html__( 'Stop job', 'plugin-wp-support-thisismyurl' ); ?></button>
			...
			<div class="timu-card-body">
				...
				<form method="get" action="" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: var(--timu-space-md); margin-bottom: var(--timu-space-lg);">
					...
					<div class="timu-form-group">
						...
						<input type="text" id="timu_log_search" name="timu_log_search" value="<?php echo esc_attr( $search_query ); ?>" placeholder="<?php echo esc_attr__( 'File, ID, operation...', 'plugin-wp-support-thisismyurl' ); ?>" class="timu-form-control" />
					</div>

					<div style="display: flex; gap: var(--timu-space-sm); align-items: flex-end;">
						<button class="timu-btn timu-btn-primary" type="submit"><?php echo esc_html__( 'Search', 'plugin-wp-support-thisismyurl' ); ?></button>
...
<?php else : ?>
	<div class="timu-card" id="timu-vault-logs">
		<div class="timu-card-body">
			<p style="color: var(--timu-text-muted); font-style: italic; margin: 0;"><?php echo esc_html__( 'No logs yet.', 'plugin-wp-support-thisismyurl' ); ?></p>
		</div>
	</div>
	<?php endif; ?>
	...
	<div class="timu-card" style="margin-top: var(--timu-space-xl);">
		<div class="timu-card-body">
			<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
				...
				<button class="timu-btn timu-btn-destructive" type="submit" name="timu_vault_log_action" value="clear_all" onclick="return confirm( '<?php echo esc_attr__( 'Clear all logs? This cannot be undone.', 'plugin-wp-support-thisismyurl' ); ?>' );"><?php echo esc_html__( 'Clear All Logs', 'plugin-wp-support-thisismyurl' ); ?></button>
			</form>
		</div>
	</div>
</div>
