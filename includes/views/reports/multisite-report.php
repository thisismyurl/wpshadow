...
<div class="wrap wps-page-container">
	...
	wpshadow_render_page_header(
		__( 'Multisite Network Report', 'wpshadow' ),
		__( 'Check all the sites in your WordPress network for health and resource usage.', 'wpshadow' ),
	...
	<div class="wps-card">
		<div class="wps-card-body">
			<div style="text-align: center; padding: 60px 20px;">
				...
				<h2><?php esc_html_e( 'Network Analysis Running...', 'wpshadow' ); ?></h2>
