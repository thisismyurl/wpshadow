...
<div class="wrap wps-page-container">
	...
	wpshadow_render_page_header(
		...
		__( 'Improve search engine visibility by optimizing titles, meta descriptions, and site structure.', 'wpshadow' ),
		'dashicons-search'
	);
	?>
	...
	<div class="wps-card">
		<div class="wps-card-body">
			<div style="text-align: center; padding: 60px 20px;">
				...
				<h2><?php esc_html_e( 'SEO Analysis in Progress...', 'wpshadow' ); ?></h2>
				<p style="font-size: 16px; color: #666; max-width: 600px; margin: 20px auto;">
					<?php esc_html_e( 'Checking if search engines can properly read your site, analyzing meta tags, sitemaps, and identifying opportunities to improve your search rankings.', 'wpshadow' ); ?>
				</p>
