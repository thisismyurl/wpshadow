...
?>
<div class="timu-setup-wizard" style="max-width: 800px; margin: 40px auto; padding: 30px; background: #fff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
	...
	<div style="margin: 30px 0; padding: 15px; background: #e7f3ff; border: 1px solid #b3d9ff; border-radius: 4px;">
		<p style="margin: 0;">
	...
	<div style="display: flex; gap: 10px; margin-top: 30px;">
		<a href="<?php echo esc_url( $install_url ); ?>" class="button button-primary" style="padding: 10px 20px; font-size: 16px;">
			<?php esc_html_e( 'Install & Activate All', 'core-support-thisismyurl' ); ?>
		</a>
		<a href="<?php echo esc_url( admin_url( 'admin.php?page=timu-core-dashboard' ) ); ?>" class="button" style="padding: 10px 20px; font-size: 16px;">
