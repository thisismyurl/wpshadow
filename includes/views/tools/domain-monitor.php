...
if ( ! $is_registered ) {
	...
	<div class="wps-card wps-card--warning">
		<div class="wps-card-body">
			...
			<p><?php esc_html_e( 'Domain monitoring relies on external WHOIS lookups and registrar APIs that should not be queried from shared hosting.', 'wpshadow' ); ?></p>
			...
			<p class="wps-help-text" style="margin-top: 15px;">
				...
				<?php esc_html_e( 'Up to 3 domains', 'wpshadow' ); ?>
			</p>
		</div>
	</div>
	<?php
...
<div class="wps-card">
	<div class="wps-card-header">
		<h3 class="wps-card-title"><?php esc_html_e( 'Domain Status', 'wpshadow' ); ?></h3>
	</div>
	<div class="wps-card-body">
...
<div class="wps-card wps-mt-6 wps-card--info">
	<div class="wps-card-body">
		...
		<ul style="list-style: disc; margin-left: 20px;">
			<li><?php esc_html_e( 'WHOIS and registrar APIs are rate-limited for shared hosting.', 'wpshadow' ); ?></li>
			<li><?php esc_html_e( 'External checks provide reliable, cached lookups.', 'wpshadow' ); ?></li>
			<li><?php esc_html_e( 'Weekly monitoring keeps your domain safe from expiration.', 'wpshadow' ); ?></li>
		</ul>
	</div>
</div>
