...
if ( ! $is_registered ) {
	...
	<div class="wps-card wps-card--warning">
		<div class="wps-card-body">
			...
			<p><?php esc_html_e( 'Image recognition requires GPU-backed AI models hosted on external servers.', 'wpshadow' ); ?></p>
			...
			<p class="wps-help-text" style="margin-top: 15px;">
				...
				<?php esc_html_e( '100 images per month', 'wpshadow' ); ?>
			</p>
		</div>
	</div>
	<?php
...
<div class="wps-card">
	<div class="wps-card-header">
		<h3 class="wps-card-title"><?php esc_html_e( 'Alt Text Status', 'wpshadow' ); ?></h3>
	</div>
	<div class="wps-card-body">
...
<div class="wps-card wps-mt-6 wps-card--info">
	<div class="wps-card-body">
		...
		<ul style="list-style: disc; margin-left: 20px;">
			<li><?php esc_html_e( 'Image recognition requires GPU compute.', 'wpshadow' ); ?></li>
			<li><?php esc_html_e( 'Central processing ensures consistent accessibility results.', 'wpshadow' ); ?></li>
			<li><?php esc_html_e( 'Bulk processing is faster on cloud infrastructure.', 'wpshadow' ); ?></li>
		</ul>
	</div>
</div>
