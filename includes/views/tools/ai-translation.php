...
if ( ! $is_registered ) {
	...
	<div class="wps-card wps-card--warning">
		<div class="wps-card-body">
			...
			<p><?php esc_html_e( 'Translation requires large language models and multilingual data hosted on external servers.', 'wpshadow' ); ?></p>
			...
			<p class="wps-help-text" style="margin-top: 15px;">
				...
				<?php esc_html_e( '10,000 words per month', 'wpshadow' ); ?>
			</p>
		</div>
	</div>
	<?php
...
<div class="wps-card">
	<div class="wps-card-header">
		<h3 class="wps-card-title"><?php esc_html_e( 'Translation Status', 'wpshadow' ); ?></h3>
	</div>
	<div class="wps-card-body">
...
<div class="wps-card wps-mt-6 wps-card--info">
	<div class="wps-card-body">
		...
		<ul style="list-style: disc; margin-left: 20px;">
			<li><?php esc_html_e( 'Multilingual models require large compute resources.', 'wpshadow' ); ?></li>
			<li><?php esc_html_e( 'Central services ensure consistent translations.', 'wpshadow' ); ?></li>
			<li><?php esc_html_e( 'Processing stays off your hosting environment.', 'wpshadow' ); ?></li>
		</ul>
	</div>
</div>
