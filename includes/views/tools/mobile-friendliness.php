	...
	<div class="wpshadow-mobile-grid">
		<div class="wpshadow-mobile-panel">
			...
			<form id="wpshadow-mobile-form">
				...
				<p class="submit">
					<button type="submit" class="wps-btn wps-btn-primary wps-btn-icon-left"><span class="dashicons dashicons-update"></span><?php esc_html_e( 'Run Mobile Check', 'wpshadow' ); ?></button>
				</p>
