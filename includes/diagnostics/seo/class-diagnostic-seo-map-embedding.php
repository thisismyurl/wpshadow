...
class Diagnostic_SEO_Map_Embedding extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: SEO Map Embedding
	 * Slug: -seo-map-embedding
	 * File: class-diagnostic-seo-map-embedding.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__seo_map_embedding(): array {
		/*
