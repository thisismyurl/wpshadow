...
class Diagnostic_Monitor_Link extends Diagnostic_Base {
  public static function check(): ?array {
	 ...
	 *
	 * Diagnostic: Monitor Link
	 * Slug: -monitor-link-anchor-text-distribution
	 * File: class-diagnostic-monitor-link-anchor-text-distribution.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__monitor_link_anchor_text_distribution(): array {
		/*
