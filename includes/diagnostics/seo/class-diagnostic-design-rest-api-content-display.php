...
class Diagnostic_Design_REST_API_CONTENT_DISPLAY extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design REST API CONTENT DISPLAY
	 * Slug: -design-rest-api-content-display
	 * File: class-diagnostic-design-rest-api-content-display.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_rest_api_content_display(): array {
		/*
