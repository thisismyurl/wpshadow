...
class Diagnostic_Monitor_Meta extends Diagnostic_Base {
  public static function check(): ?array {
	 ...
	 *
	 * Diagnostic: Monitor Meta
	 * Slug: -monitor-meta-tag-keyword-alignment
	 * File: class-diagnostic-monitor-meta-tag-keyword-alignment.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__monitor_meta_tag_keyword_alignment(): array {
		/*
