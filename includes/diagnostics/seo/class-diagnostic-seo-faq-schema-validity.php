...
class Diagnostic_SEO_FAQ_Schema_Validity extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: SEO FAQ Schema Validity
	 * Slug: -seo-faq-schema-validity
	 * File: class-diagnostic-seo-faq-schema-validity.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__seo_faq_schema_validity(): array {
		/*
