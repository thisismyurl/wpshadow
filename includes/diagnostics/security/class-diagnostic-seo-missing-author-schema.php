...
class Diagnostic_SEO_Missing_Author_Schema extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: SEO Missing Author Schema
	 * Slug: -seo-missing-author-schema
	 * File: class-diagnostic-seo-missing-author-schema.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__seo_missing_author_schema(): array {
		/*
