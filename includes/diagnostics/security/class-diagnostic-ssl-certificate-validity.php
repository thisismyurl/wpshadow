...
class Diagnostic_SSL_Certificate_Validity extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: SSL Certificate Validity
	 * Slug: -ssl-certificate-validity
	 * File: class-diagnostic-ssl-certificate-validity.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__ssl_certificate_validity(): array {
		/*
