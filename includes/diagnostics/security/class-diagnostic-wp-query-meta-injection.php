...
class Diagnostic_WP_Query_Meta_Injection extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: WP Query Meta Injection
	 * Slug: -wp-query-meta-injection
	 * File: class-diagnostic-wp-query-meta-injection.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__wp_query_meta_injection(): array {
		/*
