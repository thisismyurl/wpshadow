...
class Diagnostic_DnsAuthoritativeLatency extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: DnsAuthoritativeLatency
	 * Slug: -dns-authoritative-latency
	 * File: class-diagnostic-dns-authoritative-latency.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__dns_authoritative_latency(): array {
		/*
