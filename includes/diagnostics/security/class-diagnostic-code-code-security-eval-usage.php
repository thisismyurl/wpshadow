...
return [
	 ...
	 *
	 * Diagnostic: Code CODE SECURITY EVAL USAGE
	 * Slug: -code-code-security-eval-usage
	 * File: class-diagnostic-code-code-security-eval-usage.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__code_code_security_eval_usage(): array {
		/*
