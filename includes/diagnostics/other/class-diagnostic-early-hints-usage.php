...
class Diagnostic_Early_Hints_Usage extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Early Hints Usage
	 * Slug: -early-hints-usage
	 * File: class-diagnostic-early-hints-usage.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__early_hints_usage(): array {
		/*
