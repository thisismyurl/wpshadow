...
class Diagnostic_Performance_Regression_Detection extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Performance Regression Detection
	 * Slug: -performance-regression-detection
	 * File: class-diagnostic-performance-regression-detection.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__performance_regression_detection(): array {
		/*
