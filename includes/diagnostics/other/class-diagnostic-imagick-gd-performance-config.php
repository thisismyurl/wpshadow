...
/**
 * Diagnostic: ImageMagick/GD Performance Configuration (MEDIA-306)
 *
 * Checks image processing thread/limit settings for performance.
 ...
 * @since 1.2601.2200
 */
class Diagnostic_ImagickGdPerformanceConfig extends Diagnostic_Base {
    /**
