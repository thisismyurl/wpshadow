...
class Diagnostic_DiagnosticStaleWhileRevalidate extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: DiagnosticStaleWhileRevalidate
	 * Slug: -stale-while-revalidate
	 * File: class-diagnostic-stale-while-revalidate.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__stale_while_revalidate(): array {
		/*
