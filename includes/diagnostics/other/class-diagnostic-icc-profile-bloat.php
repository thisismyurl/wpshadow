...
/**
 * Diagnostic: ICC Profile and Color Metadata Bloat (IMG-331)
 *
 * Detects heavy color profiles/metadata in images.
 ...
 */
class Diagnostic_IccProfileBloat extends Diagnostic_Base {
	/**
	 ...
	 *
	 * Diagnostic: IccProfileBloat
	 * Slug: -icc-profile-bloat
	 * File: class-diagnostic-icc-profile-bloat.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__icc_profile_bloat(): array {
		/*
