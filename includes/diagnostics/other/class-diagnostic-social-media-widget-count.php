 ...
 */
class Diagnostic_Social_Media_Widget_Count extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Social Media Widget Count
	 * Slug: -social-media-widget-count
	 * File: class-diagnostic-social-media-widget-count.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__social_media_widget_count(): array {
		/*
