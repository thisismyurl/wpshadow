...
class Diagnostic_Benchmark_Conversion_Rate_Industry extends Diagnostic_Base {
	...
	public static function check(): ?array {
		...
		return \WPShadow\Core\Diagnostic_Lean_Checks::build_finding(
			'benchmark-conversion-rate-industry',
			'Benchmark Conversion Rate Industry',
			'Automatically initialized lean diagnostic for Benchmark Conversion Rate Industry. Optimized for minimal overhead while surfacing high-value signals.',
			'general',
			'low',
			30,
			'benchmark-conversion-rate-industry'
