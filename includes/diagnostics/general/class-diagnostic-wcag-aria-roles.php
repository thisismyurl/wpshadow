...
class Diagnostic_Wcag_Aria_Roles extends Diagnostic_Base {
	 ...
	 * - Description: Automatically initialized lean diagnostic for Wcag Aria Roles. Optimized for minimal overhead while surfacing high-value signals.
	 *
	 * @return array {
