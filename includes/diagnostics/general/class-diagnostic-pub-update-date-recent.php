...
class Diagnostic_Pub_Update_Date_Recent extends Diagnostic_Base {
	...
	protected static $title = 'Pub Update Date Recent';

	protected static $description = 'Automatically initialized lean diagnostic for Pub Update Date Recent. Optimized for minimal overhead while surfacing high-value signals.';
	...
	public static function run(): array {
		// STUB: Implement pub-update-date-recent test
	...
	public static function check(): ?array {
		...
		return \WPShadow\Core\Diagnostic_Lean_Checks::build_finding(
			...
			'Pub Update Date Recent',
			'Automatically initialized lean diagnostic for Pub Update Date Recent. Optimized for minimal overhead while surfacing high-value signals.',
			'general',
			'low',
			30,
			'pub-update-date-recent'
