...
class Diagnostic_Wcag_Focus_Order extends Diagnostic_Base {
	...
	public static function check(): ?array {
		...
		return \WPShadow\Core\Diagnostic_Lean_Checks::build_finding(
			'wcag-focus-order',
			'Wcag Focus Order',
			'Automatically initialized lean diagnostic for Wcag Focus Order. Optimized for minimal overhead while surfacing high-value signals.',
			'general',
			'low',
			30,
			'wcag-focus-order'
	 ...
	 * - Description: Automatically initialized lean diagnostic for Wcag Focus Order. Optimized for minimal overhead while surfacing high-value signals.
	 *
	 * @return array {
