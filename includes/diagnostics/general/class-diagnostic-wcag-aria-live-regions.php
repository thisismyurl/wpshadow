...
class Diagnostic_Wcag_Aria_Live_Regions extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Wcag Aria Live Regions
	 ...
	 * - Description: Automatically initialized lean diagnostic for Wcag Aria Live Regions. Optimized for minimal overhead while surfacing high-value signals.
	 *
	 * @return array {
