...
class Diagnostic_Ai_User_Privacy extends Diagnostic_Base {
	...
	public static function check(): ?array {
		...
		return \WPShadow\Core\Diagnostic_Lean_Checks::build_finding(
			'ai-user-privacy',
			'Ai User Privacy',
			'Automatically initialized lean diagnostic for Ai User Privacy. Optimized for minimal overhead while surfacing high-value signals.',
			'general',
			'low',
			30,
			'ai-user-privacy'
	 ...
	 * - Description: Automatically initialized lean diagnostic for Ai User Privacy. Optimized for minimal overhead while surfacing high-value signals.
	 *
	 * @return array {
