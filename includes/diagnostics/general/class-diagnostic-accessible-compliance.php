...
class Diagnostic_Accessible_Compliance extends Diagnostic_Base {
	...
	public static function check(): ?array {
		...
		return \WPShadow\Core\Diagnostic_Lean_Checks::build_finding(
			...
			'Accessible Compliance',
			'Automatically initialized lean diagnostic for Accessible Compliance. Optimized for minimal overhead while surfacing high-value signals.',
			'general',
			'low',
			30,
			'accessible-compliance'
	 ...
	 *
	 * Diagnostic: Accessible Compliance
	 ...
	 * - Description: Automatically initialized lean diagnostic for Accessible Compliance. Optimized for minimal overhead while surfacing high-value signals.
	 *
	 * @return array {
