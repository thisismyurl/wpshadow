...
class Diagnostic_SecApiKeysInCode extends Diagnostic_Base {
	...
	protected static $title = 'Sec Api Keys In Code';

	protected static $description = 'Automatically initialized lean diagnostic for Sec Api Keys In Code. Optimized for minimal overhead while surfacing high-value signals.';
	...
	public static function run(): array {
		// STUB: Implement sec-api-keys-in-code diagnostic
		//
	...
	public static function check(): ?array {
		...
		return \WPShadow\Core\Diagnostic_Lean_Checks::build_finding(
			...
			'Sec Api Keys In Code',
			'Automatically initialized lean diagnostic for Sec Api Keys In Code. Optimized for minimal overhead while surfacing high-value signals.',
			'general',
			'low',
			30,
			'sec-api-keys-in-code'
