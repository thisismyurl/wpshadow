...
class Diagnostic_Ai_Structured_Data extends Diagnostic_Base {
	 ...
	 * - Description: Automatically initialized lean diagnostic for Ai Structured Data. Optimized for minimal overhead while surfacing high-value signals.
	 *
	 * @return array {
