...
class Diagnostic_PerfLcpElementAnalyzer extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Perf Lcp Element Analyzer
	 ...
	 * - Description: Automatically initialized lean diagnostic for Perf Lcp Element Analyzer. Optimized for minimal overhead while surfacing high-value signals.
	 *
	 * @return array {
	 ...
	 * }
	 */
	public static function test_live_perf_lcp_element_analyzer(): array {
		/*
		 * IMPLEMENTATION NOTES:
