 ...
 */
class Diagnostic_Code_CODE_FILTER_GLOBAL_ALTER extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Code CODE FILTER GLOBAL ALTER
	 * Slug: -code-code-filter-global-alter
	 * File: class-diagnostic-code-code-filter-global-alter.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__code_code_filter_global_alter(): array {
		/*
