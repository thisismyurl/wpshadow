...
class Diagnostic_Design_BLOCK_COLOR_PALETTE extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design BLOCK COLOR PALETTE
	 * Slug: -design-block-color-palette
	 * File: class-diagnostic-design-block-color-palette.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_block_color_palette(): array {
		/*
