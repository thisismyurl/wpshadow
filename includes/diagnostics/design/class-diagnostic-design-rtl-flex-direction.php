...
class Diagnostic_Design_RTL_FLEX_DIRECTION extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design RTL FLEX DIRECTION
	 * Slug: -design-rtl-flex-direction
	 * File: class-diagnostic-design-rtl-flex-direction.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_rtl_flex_direction(): array {
		/*
