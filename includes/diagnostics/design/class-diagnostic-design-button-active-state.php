...
class Diagnostic_Design_BUTTON_ACTIVE_STATE extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design BUTTON ACTIVE STATE
	 * Slug: -design-button-active-state
	 * File: class-diagnostic-design-button-active-state.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_button_active_state(): array {
		/*
