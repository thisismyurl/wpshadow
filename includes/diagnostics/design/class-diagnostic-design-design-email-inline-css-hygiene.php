...
class Diagnostic_Design_DESIGN_EMAIL_INLINE_CSS_HYGIENE extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design DESIGN EMAIL INLINE CSS HYGIENE
	 * Slug: -design-design-email-inline-css-hygiene
	 * File: class-diagnostic-design-design-email-inline-css-hygiene.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_design_email_inline_css_hygiene(): array {
		/*
