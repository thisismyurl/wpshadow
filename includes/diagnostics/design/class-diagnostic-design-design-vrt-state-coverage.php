...
class Diagnostic_Design_DESIGN_VRT_STATE_COVERAGE extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design DESIGN VRT STATE COVERAGE
	 * Slug: -design-design-vrt-state-coverage
	 * File: class-diagnostic-design-design-vrt-state-coverage.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_design_vrt_state_coverage(): array {
		/*
