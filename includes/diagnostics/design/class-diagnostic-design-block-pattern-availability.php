...
class Diagnostic_Design_BLOCK_PATTERN_AVAILABILITY extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design BLOCK PATTERN AVAILABILITY
	 * Slug: -design-block-pattern-availability
	 * File: class-diagnostic-design-block-pattern-availability.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_block_pattern_availability(): array {
		/*
