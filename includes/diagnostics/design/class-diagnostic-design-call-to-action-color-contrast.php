...
class Diagnostic_Design_CALL_TO_ACTION_COLOR_CONTRAST extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design CALL TO ACTION COLOR CONTRAST
	 * Slug: -design-call-to-action-color-contrast
	 * File: class-diagnostic-design-call-to-action-color-contrast.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_call_to_action_color_contrast(): array {
		/*
