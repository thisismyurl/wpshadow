...
class Diagnostic_Design_DESIGN_ICON_SYSTEM_DUPLICATION extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design DESIGN ICON SYSTEM DUPLICATION
	 * Slug: -design-design-icon-system-duplication
	 * File: class-diagnostic-design-design-icon-system-duplication.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_design_icon_system_duplication(): array {
		/*
