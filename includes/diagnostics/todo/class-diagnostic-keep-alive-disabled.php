...
class Diagnostic_Keep_Alive_Disabled extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Keep Alive Disabled
	 * Slug: -keep-alive-disabled
	 * File: class-diagnostic-keep-alive-disabled.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__keep_alive_disabled(): array {
		/*
