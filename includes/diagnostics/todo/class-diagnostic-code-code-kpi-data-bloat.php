...
class Diagnostic_Code_CODE_KPI_DATA_BLOAT extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Code CODE KPI DATA BLOAT
	 * Slug: -code-code-kpi-data-bloat
	 * File: class-diagnostic-code-code-kpi-data-bloat.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__code_code_kpi_data_bloat(): array {
		/*
