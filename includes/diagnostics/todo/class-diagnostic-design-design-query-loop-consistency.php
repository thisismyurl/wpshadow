...
class Diagnostic_Design_DESIGN_QUERY_LOOP_CONSISTENCY extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design DESIGN QUERY LOOP CONSISTENCY
	 * Slug: -design-design-query-loop-consistency
	 * File: class-diagnostic-design-design-query-loop-consistency.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_design_query_loop_consistency(): array {
		/*
