...
class Diagnostic_Design_BUTTON_SYSTEM_DEFINITION extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design BUTTON SYSTEM DEFINITION
	 * Slug: -design-button-system-definition
	 * File: class-diagnostic-design-button-system-definition.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_button_system_definition(): array {
		/*
