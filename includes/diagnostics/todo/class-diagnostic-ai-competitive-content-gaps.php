...
class Diagnostic_AiCompetitiveContentGaps extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Ai Competitive Content Gaps
	 ...
	 * - Description: Automatically initialized lean diagnostic for Ai Competitive Content Gaps. Optimized for minimal overhead while surfacing high-value signals.
	 *
	 * @return array {
