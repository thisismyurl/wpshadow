...
class Diagnostic_Design_DESIGN_CROSS_TEMPLATE_DRIFT extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design DESIGN CROSS TEMPLATE DRIFT
	 * Slug: -design-design-cross-template-drift
	 * File: class-diagnostic-design-design-cross-template-drift.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_design_cross_template_drift(): array {
		/*
