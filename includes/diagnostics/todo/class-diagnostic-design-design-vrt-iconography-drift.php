...
class Diagnostic_Design_DESIGN_VRT_ICONOGRAPHY_DRIFT extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design DESIGN VRT ICONOGRAPHY DRIFT
	 * Slug: -design-design-vrt-iconography-drift
	 * File: class-diagnostic-design-design-vrt-iconography-drift.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_design_vrt_iconography_drift(): array {
		/*
