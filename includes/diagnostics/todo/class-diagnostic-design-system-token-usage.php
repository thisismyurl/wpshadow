...
class Diagnostic_Design_SYSTEM_TOKEN_USAGE extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design SYSTEM TOKEN USAGE
	 * Slug: -design-system-token-usage
	 * File: class-diagnostic-design-system-token-usage.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_system_token_usage(): array {
		/*
