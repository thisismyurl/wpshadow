...
class Diagnostic_Code_CODE_PERF_RECOMPUTED_DATA extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Code CODE PERF RECOMPUTED DATA
	 * Slug: -code-code-perf-recomputed-data
	 * File: class-diagnostic-code-code-perf-recomputed-data.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__code_code_perf_recomputed_data(): array {
		/*
