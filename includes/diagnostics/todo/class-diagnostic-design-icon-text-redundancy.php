...
class Diagnostic_Design_ICON_TEXT_REDUNDANCY extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design ICON TEXT REDUNDANCY
	 * Slug: -design-icon-text-redundancy
	 * File: class-diagnostic-design-icon-text-redundancy.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_icon_text_redundancy(): array {
		/*
