...
return [
	 ...
	 *
	 * Diagnostic: Code CODE SECURITY UNSANITIZED INPUT
	 * Slug: -code-code-security-unsanitized-input
	 * File: class-diagnostic-code-code-security-unsanitized-input.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__code_code_security_unsanitized_input(): array {
		/*
