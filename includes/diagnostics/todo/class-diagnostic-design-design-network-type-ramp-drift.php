...
class Diagnostic_Design_DESIGN_NETWORK_TYPE_RAMP_DRIFT extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design DESIGN NETWORK TYPE RAMP DRIFT
	 * Slug: -design-design-network-type-ramp-drift
	 * File: class-diagnostic-design-design-network-type-ramp-drift.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_design_network_type_ramp_drift(): array {
		/*
