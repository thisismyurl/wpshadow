...
class Diagnostic_Code_CODE_STANDARDS_TEXT_DOMAIN extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Code CODE STANDARDS TEXT DOMAIN
	 * Slug: -code-code-standards-text-domain
	 * File: class-diagnostic-code-code-standards-text-domain.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__code_code_standards_text_domain(): array {
		/*
