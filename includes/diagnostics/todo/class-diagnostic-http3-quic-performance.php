...
class Diagnostic_DiagnosticHttp3QuicPerformance extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: DiagnosticHttp3QuicPerformance
	 * Slug: -http3-quic-performance
	 * File: class-diagnostic-http3-quic-performance.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__http3_quic_performance(): array {
		/*
