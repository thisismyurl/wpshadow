 ...
 */
class Diagnostic_Code_CODE_ERRORS_VERBOSE_PRODUCTION extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Code CODE ERRORS VERBOSE PRODUCTION
	 * Slug: -code-code-errors-verbose-production
	 * File: class-diagnostic-code-code-errors-verbose-production.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__code_code_errors_verbose_production(): array {
		/*
