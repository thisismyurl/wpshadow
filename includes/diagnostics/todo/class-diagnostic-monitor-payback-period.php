...
class Diagnostic_Monitor_Payback extends Diagnostic_Base {
  public static function check(): ?array {
	 ...
	 *
	 * Diagnostic: Monitor Payback
	 * Slug: -monitor-payback-period
	 * File: class-diagnostic-monitor-payback-period.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__monitor_payback_period(): array {
		/*
