...
class Diagnostic_HttpKeepAliveReuse extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: HttpKeepAliveReuse
	 * Slug: -http-keep-alive-reuse
	 * File: class-diagnostic-http-keep-alive-reuse.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__http_keep_alive_reuse(): array {
		/*
