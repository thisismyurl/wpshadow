...
class Diagnostic_Design_DESIGN_MENU_WIDGET_STYLING extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design DESIGN MENU WIDGET STYLING
	 * Slug: -design-design-menu-widget-styling
	 * File: class-diagnostic-design-design-menu-widget-styling.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_design_menu_widget_styling(): array {
		/*
