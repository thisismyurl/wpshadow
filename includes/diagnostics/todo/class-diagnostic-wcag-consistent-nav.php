...
/**
 * Diagnostic: Is navigation consistent?
 *
...
class Diagnostic_Wcag_Consistent_Nav extends Diagnostic_Base {
	...
	public static function check(): ?array {
		...
		return \WPShadow\Core\Diagnostic_Lean_Checks::build_finding(
			'wcag-consistent-nav',
			'Wcag Consistent Nav',
			'Automatically initialized lean diagnostic for Wcag Consistent Nav. Optimized for minimal overhead while surfacing high-value signals.',
			'general',
			'low',
			30,
			'wcag-consistent-nav'
	 ...
	 *
	 * Diagnostic: Wcag Consistent Nav
	 * Slug: wcag-consistent-nav
	 * 
	 * Test Purpose:
	 * - Verify that check() method returns the correct result based on site state
	 * - PASS: check() returns NULL when diagnostic condition is NOT met (site is healthy)
	 * - FAIL: check() returns array when diagnostic condition IS met (issue found)
	 * - Description: Automatically initialized lean diagnostic for Wcag Consistent Nav. Optimized for minimal overhead while surfacing high-value signals.
	 *
	 * @return array {
