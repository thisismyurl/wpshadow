...
class Diagnostic_Code_CODE_HYGIENE_STALE_TEMPLATES extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Code CODE HYGIENE STALE TEMPLATES
	 * Slug: -code-code-hygiene-stale-templates
	 * File: class-diagnostic-code-code-hygiene-stale-templates.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__code_code_hygiene_stale_templates(): array {
		/*
