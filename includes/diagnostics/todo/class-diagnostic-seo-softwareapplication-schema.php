...
class Diagnostic_SEO_SoftwareApplication_Schema extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: SEO SoftwareApplication Schema
	 * Slug: -seo-softwareapplication-schema
	 * File: class-diagnostic-seo-softwareapplication-schema.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__seo_softwareapplication_schema(): array {
		/*
