...
class Diagnostic_SEO_Canonical_Hreflang_Consistency extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: SEO Canonical Hreflang Consistency
	 * Slug: -seo-canonical-hreflang-consistency
	 * File: class-diagnostic-seo-canonical-hreflang-consistency.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__seo_canonical_hreflang_consistency(): array {
		/*
