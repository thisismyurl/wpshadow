...
class Diagnostic_Code_CODE_CURRENT_USER_CAN_MISUSE extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Code CODE CURRENT USER CAN MISUSE
	 * Slug: -code-code-current-user-can-misuse
	 * File: class-diagnostic-code-code-current-user-can-misuse.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__code_code_current_user_can_misuse(): array {
		/*
