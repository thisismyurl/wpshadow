...
class Diagnostic_Design_EMAIL_TEMPLATE_STYLING extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design EMAIL TEMPLATE STYLING
	 * Slug: -design-email-template-styling
	 * File: class-diagnostic-design-email-template-styling.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_email_template_styling(): array {
		/*
