...
class Diagnostic_Monitor_Product extends Diagnostic_Base {
  public static function check(): ?array {
	 ...
	 *
	 * Diagnostic: Monitor Product
	 * Slug: -monitor-product-schema-completeness
	 * File: class-diagnostic-monitor-product-schema-completeness.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__monitor_product_schema_completeness(): array {
		/*
