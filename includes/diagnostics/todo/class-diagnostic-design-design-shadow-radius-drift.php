...
class Diagnostic_Design_DESIGN_SHADOW_RADIUS_DRIFT extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design DESIGN SHADOW RADIUS DRIFT
	 * Slug: -design-design-shadow-radius-drift
	 * File: class-diagnostic-design-design-shadow-radius-drift.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_design_shadow_radius_drift(): array {
		/*
