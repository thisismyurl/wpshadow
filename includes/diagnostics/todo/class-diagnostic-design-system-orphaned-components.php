...
class Diagnostic_Design_SYSTEM_ORPHANED_COMPONENTS extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design SYSTEM ORPHANED COMPONENTS
	 * Slug: -design-system-orphaned-components
	 * File: class-diagnostic-design-system-orphaned-components.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_system_orphaned_components(): array {
		/*
