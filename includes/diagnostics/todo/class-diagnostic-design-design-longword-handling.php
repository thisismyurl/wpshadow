...
class Diagnostic_Design_DESIGN_LONGWORD_HANDLING extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design DESIGN LONGWORD HANDLING
	 * Slug: -design-design-longword-handling
	 * File: class-diagnostic-design-design-longword-handling.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_design_longword_handling(): array {
		/*
