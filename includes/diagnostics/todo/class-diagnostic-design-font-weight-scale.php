...
class Diagnostic_Design_FONT_WEIGHT_SCALE extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design FONT WEIGHT SCALE
	 * Slug: -design-font-weight-scale
	 * File: class-diagnostic-design-font-weight-scale.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_font_weight_scale(): array {
		/*
