...
class Diagnostic_Design_DESIGN_TABLE_CONSISTENCY extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design DESIGN TABLE CONSISTENCY
	 * Slug: -design-design-table-consistency
	 * File: class-diagnostic-design-design-table-consistency.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_design_table_consistency(): array {
		/*
