...
class Diagnostic_Design_JAVASCRIPT_ES6_TRANSPILING extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design JAVASCRIPT ES6 TRANSPILING
	 * Slug: -design-javascript-es6-transpiling
	 * File: class-diagnostic-design-javascript-es6-transpiling.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_javascript_es6_transpiling(): array {
		/*
