...
class Diagnostic_Design_DESIGN_LOOP_CONSISTENCY extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design DESIGN LOOP CONSISTENCY
	 * Slug: -design-design-loop-consistency
	 * File: class-diagnostic-design-design-loop-consistency.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_design_loop_consistency(): array {
		/*
