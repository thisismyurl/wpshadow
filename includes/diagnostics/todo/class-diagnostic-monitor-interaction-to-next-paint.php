...
class Diagnostic_Monitor_Interaction extends Diagnostic_Base {
  public static function check(): ?array {
	 ...
	 *
	 * Diagnostic: Monitor Interaction
	 * Slug: -monitor-interaction-to-next-paint
	 * File: class-diagnostic-monitor-interaction-to-next-paint.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__monitor_interaction_to_next_paint(): array {
		/*
