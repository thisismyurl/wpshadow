...
class Diagnostic_Code_CODE_BACKGROUND_NO_LIMITS extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Code CODE BACKGROUND NO LIMITS
	 * Slug: -code-code-background-no-limits
	 * File: class-diagnostic-code-code-background-no-limits.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__code_code_background_no_limits(): array {
		/*
