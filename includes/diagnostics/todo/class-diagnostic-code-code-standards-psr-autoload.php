...
class Diagnostic_Code_CODE_STANDARDS_PSR_AUTOLOAD extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Code CODE STANDARDS PSR AUTOLOAD
	 * Slug: -code-code-standards-psr-autoload
	 * File: class-diagnostic-code-code-standards-psr-autoload.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__code_code_standards_psr_autoload(): array {
		/*
