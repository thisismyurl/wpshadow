...
class Diagnostic_Monitor_Breadth extends Diagnostic_Base {
  public static function check(): ?array {
	 ...
	 *
	 * Diagnostic: Monitor Breadth
	 * Slug: -monitor-breadth-coverage
	 * File: class-diagnostic-monitor-breadth-coverage.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__monitor_breadth_coverage(): array {
		/*
