...
class Diagnostic_Uptime_Monitoring extends Diagnostic_Base {
    ...
    public static function check(): ?array {
        return array(
            ...
            'color'         => '#9e9e9e',
            'bg_color'      => '#f5f5f5',
            'kb_link'       => 'https://wpshadow.com/kb/uptime-monitoring/?utm_source=wpshadow&utm_medium=dashboard&utm_campaign=uptime-monitoring',
            'training_link' => 'https://wpshadow.com/training/uptime-monitoring/',
            'auto_fixable'  => false,
            'threat_level'  => 60,
            'module'        => 'Monitoring',
            'priority'      => 1,
