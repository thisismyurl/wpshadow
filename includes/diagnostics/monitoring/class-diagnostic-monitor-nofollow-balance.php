...
class Diagnostic_Monitor_Nofollow extends Diagnostic_Base {
  public static function check(): ?array {
	 ...
	 *
	 * Diagnostic: Monitor Nofollow
	 * Slug: -monitor-nofollow-balance
	 * File: class-diagnostic-monitor-nofollow-balance.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__monitor_nofollow_balance(): array {
		/*
