...
class Diagnostic_Monitor_Campaign extends Diagnostic_Base {
  public static function check(): ?array {
	 ...
	 *
	 * Diagnostic: Monitor Campaign
	 * Slug: -monitor-campaign-tracking-accuracy
	 * File: class-diagnostic-monitor-campaign-tracking-accuracy.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__monitor_campaign_tracking_accuracy(): array {
		/*
