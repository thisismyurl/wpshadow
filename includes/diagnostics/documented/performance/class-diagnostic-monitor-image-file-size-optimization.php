...
class Diagnostic_Monitor_Image extends Diagnostic_Base {
  public static function check(): ?array {
	 ...
	 * Slug: -monitor-image-file-size-optimization
	 * File: class-diagnostic-monitor-image-file-size-optimization.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__monitor_image_file_size_optimization(): array {
		/*
