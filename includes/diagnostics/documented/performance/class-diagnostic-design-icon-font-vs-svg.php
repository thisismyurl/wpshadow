 ...
 */
class Diagnostic_Design_ICON_FONT_VS_SVG extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design ICON FONT VS SVG
	 * Slug: -design-icon-font-vs-svg
	 * File: class-diagnostic-design-icon-font-vs-svg.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_icon_font_vs_svg(): array {
		/*
