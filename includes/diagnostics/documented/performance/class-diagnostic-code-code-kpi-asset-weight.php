...
class Diagnostic_Code_CODE_KPI_ASSET_WEIGHT extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Code CODE KPI ASSET WEIGHT
	 * Slug: -code-code-kpi-asset-weight
	 * File: class-diagnostic-code-code-kpi-asset-weight.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__code_code_kpi_asset_weight(): array {
		/*
