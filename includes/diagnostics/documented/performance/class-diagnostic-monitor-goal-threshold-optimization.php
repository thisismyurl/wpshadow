...
class Diagnostic_Monitor_Goal extends Diagnostic_Base {
  public static function check(): ?array {
	 ...
	 *
	 * Diagnostic: Monitor Goal
	 * Slug: -monitor-goal-threshold-optimization
	 * File: class-diagnostic-monitor-goal-threshold-optimization.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__monitor_goal_threshold_optimization(): array {
		/*
