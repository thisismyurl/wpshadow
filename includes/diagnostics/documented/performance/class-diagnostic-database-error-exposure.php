...
class Diagnostic_Database_Error_Exposure extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Database Error Exposure
	 * Slug: -database-error-exposure
	 * File: class-diagnostic-database-error-exposure.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__database_error_exposure(): array {
		/*
