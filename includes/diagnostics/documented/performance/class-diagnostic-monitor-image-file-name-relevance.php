...
class Diagnostic_Monitor_Image extends Diagnostic_Base {
  public static function check(): ?array {
	 ...
	 * Slug: -monitor-image-file-name-relevance
	 * File: class-diagnostic-monitor-image-file-name-relevance.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__monitor_image_file_name_relevance(): array {
		/*
