...
class Diagnostic_Excessive_Image_Dimensions extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Excessive Image Dimensions
	 * Slug: -excessive-image-dimensions
	 * File: class-diagnostic-excessive-image-dimensions.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__excessive_image_dimensions(): array {
		/*
