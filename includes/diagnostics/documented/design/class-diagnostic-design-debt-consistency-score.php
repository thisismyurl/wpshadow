...
class Diagnostic_Design_DEBT_CONSISTENCY_SCORE extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design DEBT CONSISTENCY SCORE
	 * Slug: -design-debt-consistency-score
	 * File: class-diagnostic-design-debt-consistency-score.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_debt_consistency_score(): array {
		/*
