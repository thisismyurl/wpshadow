...
class Diagnostic_Design_DESIGN_VRT_BORDER_RADIUS_DRIFT extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design DESIGN VRT BORDER RADIUS DRIFT
	 * Slug: -design-design-vrt-border-radius-drift
	 * File: class-diagnostic-design-design-vrt-border-radius-drift.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_design_vrt_border_radius_drift(): array {
		/*
