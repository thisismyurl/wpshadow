...
class Diagnostic_Design_DESIGN_GRID_CONSISTENCY_SCORE extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design DESIGN GRID CONSISTENCY SCORE
	 * Slug: -design-design-grid-consistency-score
	 * File: class-diagnostic-design-design-grid-consistency-score.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_design_grid_consistency_score(): array {
		/*
