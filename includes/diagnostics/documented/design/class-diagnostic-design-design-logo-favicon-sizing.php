...
class Diagnostic_Design_DESIGN_LOGO_FAVICON_SIZING extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design DESIGN LOGO FAVICON SIZING
	 * Slug: -design-design-logo-favicon-sizing
	 * File: class-diagnostic-design-design-logo-favicon-sizing.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_design_logo_favicon_sizing(): array {
		/*
