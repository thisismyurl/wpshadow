...
class Diagnostic_Design_DESIGN_NONCRITICAL_CSS_DEFERRABLE extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design DESIGN NONCRITICAL CSS DEFERRABLE
	 * Slug: -design-design-noncritical-css-deferrable
	 * File: class-diagnostic-design-design-noncritical-css-deferrable.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_design_noncritical_css_deferrable(): array {
		/*
