...
class Diagnostic_Users_Session_Duration_Avg extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Users Session Duration Avg
	 ...
	 * - Description: Automatically initialized lean diagnostic for Users Session Duration Avg. Optimized for minimal overhead while surfacing high-value signals.
	 *
	 * @return array {
	 ...
	 * }
	 */
	public static function test_live_users_session_duration_avg(): array {
		/*
