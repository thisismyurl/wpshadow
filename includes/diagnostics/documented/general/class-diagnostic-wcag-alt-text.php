...
class Diagnostic_Wcag_Alt_Text extends Diagnostic_Base {
	 ...
	 * - Description: Automatically initialized lean diagnostic for Wcag Alt Text. Optimized for minimal overhead while surfacing high-value signals.
	 *
	 * @return array {
