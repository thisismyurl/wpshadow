...
class Diagnostic_Design_MOBILE_FIRST_RESPONSIVE extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design MOBILE FIRST RESPONSIVE
	 * Slug: -design-mobile-first-responsive
	 * File: class-diagnostic-design-mobile-first-responsive.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_mobile_first_responsive(): array {
		/*
