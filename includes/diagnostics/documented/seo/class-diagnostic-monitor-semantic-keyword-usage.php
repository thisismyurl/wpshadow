...
class Diagnostic_Monitor_Semantic extends Diagnostic_Base {
  public static function check(): ?array {
	 ...
	 *
	 * Diagnostic: Monitor Semantic
	 * Slug: -monitor-semantic-keyword-usage
	 * File: class-diagnostic-monitor-semantic-keyword-usage.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__monitor_semantic_keyword_usage(): array {
		/*
