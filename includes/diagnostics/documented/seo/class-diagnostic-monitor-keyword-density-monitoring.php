...
class Diagnostic_Monitor_Keyword extends Diagnostic_Base {
  public static function check(): ?array {
	 ...
	 * Slug: -monitor-keyword-density-monitoring
	 * File: class-diagnostic-monitor-keyword-density-monitoring.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__monitor_keyword_density_monitoring(): array {
		/*
