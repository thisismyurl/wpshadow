...
class Diagnostic_Php_Max_Execution_Time_Too_Short extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Php Max Execution Time Too Short
	 * Slug: -php-max-execution-time-too-short
	 * File: class-diagnostic-php-max-execution-time-too-short.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__php_max_execution_time_too_short(): array {
		/*
