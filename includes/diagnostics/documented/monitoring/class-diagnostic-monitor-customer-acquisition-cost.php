...
class Diagnostic_Monitor_Customer extends Diagnostic_Base {
  public static function check(): ?array {
	 ...
	 * Slug: -monitor-customer-acquisition-cost
	 * File: class-diagnostic-monitor-customer-acquisition-cost.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__monitor_customer_acquisition_cost(): array {
		/*
