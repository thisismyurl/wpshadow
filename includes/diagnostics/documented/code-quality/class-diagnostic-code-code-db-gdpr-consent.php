...
class Diagnostic_Code_CODE_DB_GDPR_CONSENT extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Code CODE DB GDPR CONSENT
	 * Slug: -code-code-db-gdpr-consent
	 * File: class-diagnostic-code-code-db-gdpr-consent.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__code_code_db_gdpr_consent(): array {
		/*
