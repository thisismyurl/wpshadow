 ...
 */
class Diagnostic_Code_CODE_PERF_N_PLUS_ONE extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Code CODE PERF N PLUS ONE
	 * Slug: -code-code-perf-n-plus-one
	 * File: class-diagnostic-code-code-perf-n-plus-one.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__code_code_perf_n_plus_one(): array {
		/*
