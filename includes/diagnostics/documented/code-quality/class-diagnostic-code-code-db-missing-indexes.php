...
class Diagnostic_Code_CODE_DB_MISSING_INDEXES extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Code CODE DB MISSING INDEXES
	 * Slug: -code-code-db-missing-indexes
	 * File: class-diagnostic-code-code-db-missing-indexes.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__code_code_db_missing_indexes(): array {
		/*
