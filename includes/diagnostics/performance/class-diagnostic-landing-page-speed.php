...
class Diagnostic_Landing_Page_Speed extends Diagnostic_Base {
    ...
    public static function check(): ?array {
        return array(
            ...
            'color'         => '#9e9e9e',
            'bg_color'      => '#f5f5f5',
            'kb_link'       => 'https://wpshadow.com/kb/landing-page-speed/?utm_source=wpshadow&utm_medium=dashboard&utm_campaign=landing-page-speed',
            'training_link' => 'https://wpshadow.com/training/landing-page-speed/',
            'auto_fixable'  => false,
            'threat_level'  => 60,
            'module'        => 'Performance',
            'priority'      => 1,
