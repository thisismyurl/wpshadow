...
class Diagnostic_Mobile_Experience extends Diagnostic_Base {
    ...
    public static function check(): ?array {
        return array(
            ...
            'color'         => '#9e9e9e',
            'bg_color'      => '#f5f5f5',
            'kb_link'       => 'https://wpshadow.com/kb/mobile-experience/?utm_source=wpshadow&utm_medium=dashboard&utm_campaign=mobile-experience',
            'training_link' => 'https://wpshadow.com/training/mobile-experience/',
            'auto_fixable'  => false,
            'threat_level'  => 60,
            'module'        => 'Performance',
            'priority'      => 1,
