...
class Diagnostic_Multisite_Scalability extends Diagnostic_Base {
    ...
    public static function check(): ?array {
        return array(
            ...
            'color'         => '#9e9e9e',
            'bg_color'      => '#f5f5f5',
            'kb_link'       => 'https://wpshadow.com/kb/multisite-scalability/?utm_source=wpshadow&utm_medium=dashboard&utm_campaign=multisite-scalability',
            'training_link' => 'https://wpshadow.com/training/multisite-scalability/',
            'auto_fixable'  => false,
            'threat_level'  => 60,
            'module'        => 'Performance',
            'priority'      => 1,
