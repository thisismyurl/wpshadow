...
class Diagnostic_Traffic_Spike_Handling extends Diagnostic_Base {
    ...
    public static function check(): ?array {
        return array(
            ...
            'color'         => '#9e9e9e',
            'bg_color'      => '#f5f5f5',
            'kb_link'       => 'https://wpshadow.com/kb/traffic-spike-handling/?utm_source=wpshadow&utm_medium=dashboard&utm_campaign=traffic-spike-handling',
            'training_link' => 'https://wpshadow.com/training/traffic-spike-handling/',
            'auto_fixable'  => false,
            'threat_level'  => 60,
            'module'        => 'Performance',
            'priority'      => 1,
