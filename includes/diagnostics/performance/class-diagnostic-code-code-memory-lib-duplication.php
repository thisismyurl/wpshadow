 ...
 */
class Diagnostic_Code_CODE_MEMORY_LIB_DUPLICATION extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Code CODE MEMORY LIB DUPLICATION
	 * Slug: -code-code-memory-lib-duplication
	 * File: class-diagnostic-code-code-memory-lib-duplication.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__code_code_memory_lib_duplication(): array {
		/*
