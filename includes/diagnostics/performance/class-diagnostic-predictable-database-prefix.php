...
class Diagnostic_Predictable_Database_Prefix extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Predictable Database Prefix
	 * Slug: -predictable-database-prefix
	 * File: class-diagnostic-predictable-database-prefix.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__predictable_database_prefix(): array {
		/*
