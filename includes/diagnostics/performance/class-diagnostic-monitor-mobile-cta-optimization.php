...
class Diagnostic_Monitor_Mobile extends Diagnostic_Base {
  public static function check(): ?array {
	 ...
	 *
	 * Diagnostic: Monitor Mobile
	 * Slug: -monitor-mobile-cta-optimization
	 * File: class-diagnostic-monitor-mobile-cta-optimization.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__monitor_mobile_cta_optimization(): array {
		/*
