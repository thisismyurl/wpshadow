 ...
 */
class Diagnostic_Code_CODE_KPI_MEMORY_USAGE extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Code CODE KPI MEMORY USAGE
	 * Slug: -code-code-kpi-memory-usage
	 * File: class-diagnostic-code-code-kpi-memory-usage.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__code_code_kpi_memory_usage(): array {
		/*
