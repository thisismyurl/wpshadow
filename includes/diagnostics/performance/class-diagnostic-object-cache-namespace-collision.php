...
class Diagnostic_DiagnosticObjectCacheNamespaceCollision extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: DiagnosticObjectCacheNamespaceCollision
	 * Slug: -object-cache-namespace-collision
	 * File: class-diagnostic-object-cache-namespace-collision.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__object_cache_namespace_collision(): array {
		/*
