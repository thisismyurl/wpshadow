...
class Diagnostic_Design_DESIGN_NETWORK_CARD_CONSISTENCY extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design DESIGN NETWORK CARD CONSISTENCY
	 * Slug: -design-design-network-card-consistency
	 * File: class-diagnostic-design-design-network-card-consistency.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_design_network_card_consistency(): array {
		/*
