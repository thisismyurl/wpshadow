...
class Diagnostic_Design_DESIGN_NETWORK_RTL_COVERAGE extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design DESIGN NETWORK RTL COVERAGE
	 * Slug: -design-design-network-rtl-coverage
	 * File: class-diagnostic-design-design-network-rtl-coverage.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_design_network_rtl_coverage(): array {
		/*
