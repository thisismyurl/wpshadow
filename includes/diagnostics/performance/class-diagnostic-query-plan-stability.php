...
/**
 * Diagnostic: Query Plan Stability (DB-307)
 *
 * Detects plan flips after data growth or schema changes.
 ...
 */
class Diagnostic_QueryPlanStability extends Diagnostic_Base {
    /**
