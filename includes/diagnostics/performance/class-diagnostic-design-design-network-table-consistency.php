...
class Diagnostic_Design_DESIGN_NETWORK_TABLE_CONSISTENCY extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Design DESIGN NETWORK TABLE CONSISTENCY
	 * Slug: -design-design-network-table-consistency
	 * File: class-diagnostic-design-design-network-table-consistency.php
	 * 
	 * Test Purpose:
	 ...
	 * }
	 */
	public static function test_live__design_design_network_table_consistency(): array {
		/*
