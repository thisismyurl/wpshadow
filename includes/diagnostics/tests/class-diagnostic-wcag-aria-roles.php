 ...
 * ==============================
 *
 * Question to Answer: Are ARIA roles valid?
 *
 * Category: Accessibility & Inclusivity
 * Slug: wcag-aria-roles
 *
 * Purpose:
 * Determine if the WordPress site meets Accessibility & Inclusivity criteria related to:
 * Automatically initialized lean diagnostic for Wcag Aria Roles. Optimized for minimal overhead while ...
 */
