	...
	private static function get_permalink_recommendations(): array {
		return array(
			array(
				...
				'pros'      => array( 'Simple', 'SEO-friendly', 'Readable' ),
				'cons'      => array( 'No category info' ),
			),
			array(
				'structure' => '/%category%/%postname%/',
				'example'   => '/blog/my-awesome-post/',
				'pros'      => array( 'Category context', 'Organized', 'SEO-friendly' ),
				'cons'      => array( 'Category changes break URLs' ),
			),
			array(
				'structure' => '/%year%/%monthnum%/%postname%/',
				'example'   => '/2026/01/my-awesome-post/',
				'pros'      => array( 'Date context', 'Archive-friendly', 'SEO-friendly' ),
				'cons'      => array( 'Longer URLs' ),
			),
		);
	}
