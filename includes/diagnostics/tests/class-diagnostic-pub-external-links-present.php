 ...
 * ==============================
 *
 * Question to Answer: External Links Present
 *
 * Category: Content Publishing
 ...
 * Automatically initialized lean diagnostic for Pub External Links Present. Optimized for minimal over...
 */
 ...
 * =================================================
 * 
 * Question: External Links Present
 * Slug: pub-external-links-present
 * Category: Content Publishing
 * 
...
class Diagnostic_Pub_External_Links_Present extends Diagnostic_Base {
	...
	protected static $title = 'Pub External Links Present';

	protected static $description = 'Automatically initialized lean diagnostic for Pub External Links Present. Optimized for minimal overhead while surfacing high-value signals.';
	...
	public static function check(): ?array {
		...
		return \WPShadow\Core\Diagnostic_Lean_Checks::build_finding(
			...
			'Pub External Links Present',
			'Automatically initialized lean diagnostic for Pub External Links Present. Optimized for minimal overhead while surfacing high-value signals.',
			'general',
			'low',
			30,
			'pub-external-links-present'
