...
/**
 * Diagnostic: Are network plugins causing problems?
 *
 ...
 *
 * Test Description:
 * Are network plugins causing problems?
 *
 * @package WPShadow
 ...
 * ==============================
 *
 * Question to Answer: Are network plugins causing problems?
 *
 * Category: WordPress Ecosystem Health
 * Slug: plugin-multisite-issues
 *
 * Purpose:
 * Determine if the WordPress site meets WordPress Ecosystem Health criteria related to:
 * Automatically initialized lean diagnostic for Plugin Multisite Issues. Optimized for minimal overhea...
 */
 ...
 * ================================================
 *
 * Question: Are network plugins causing problems?
 * Slug: plugin-multisite-issues
 * Category: WordPress Ecosystem Health
 *
...
class Diagnostic_Plugin_Multisite_Issues extends Diagnostic_Base {
	...
	protected static $description = 'Automatically initialized lean diagnostic for Plugin Multisite Issues. Optimized for minimal overhead while surfacing high-value signals.';
	...
	public static function get_id(): string {
		return 'plugin-multisite-issues';
	}
	...
	public static function get_name(): string {
		return __( 'Are network plugins causing problems?', 'wpshadow' );
	}
	...
	public static function get_description(): string {
		return __( 'Are network plugins causing problems?. Part of WordPress Ecosystem Health analysis.', 'wpshadow' );
	}
	...
	public static function run(): array {
		// Implement: Are network plugins causing problems? test
	...
	public static function get_kb_article(): string {
		return 'https://wpshadow.com/kb/plugin-multisite-issues/';
	}
	...
	public static function get_training_video(): string {
		return 'https://wpshadow.com/training/plugin-multisite-issues/';
	}

	public static function check(): ?array {
		// Check for multisite-specific plugin issues
		if ( ! is_multisite() ) {
			return null; // Not applicable - single site
		}

		// Check for plugins that should be network-activated but aren't
		$network_plugins = get_site_option( 'active_sitewide_plugins', [] );
		$network_count = count( $network_plugins );

		// If multisite but no network plugins activated
		if ( $network_count === 0 ) {
			return \WPShadow\Core\Diagnostic_Lean_Checks::build_finding(
				'plugin-multisite-issues',
				'Plugin Multisite Issues',
				'No network-activated plugins detected. Consider network-activating security and performance plugins.',
				'performance',
				'low',
				25,
				'plugin-multisite-issues'
	 ...
	 *
	 * Diagnostic: Plugin Multisite Issues
	 * Slug: plugin-multisite-issues
	 *
	 * Test Purpose:
	 ...
	 * - Description: Automatically initialized lean diagnostic for Plugin Multisite Issues. Optimized for minimal overhead while surfacing high-value signals.
	 *
	 * @return array {
	 ...
	 * }
	 */
	public static function test_live_plugin_multisite_issues(): array {
		/*
