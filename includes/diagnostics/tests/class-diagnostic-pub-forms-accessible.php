...
/**
 * Diagnostic: Forms Are Accessible
 *
 ...
 * ==============================
 *
 * Question to Answer: Forms Are Accessible
 *
 * Category: Content Publishing
 ...
 * Automatically initialized lean diagnostic for Pub Forms Accessible. Optimized for minimal overhead w...
 */
...
class Diagnostic_Pub_Forms_Accessible extends Diagnostic_Base {
	...
	protected static $description = 'Automatically initialized lean diagnostic for Pub Forms Accessible. Optimized for minimal overhead while surfacing high-value signals.';
	...
	public static function run(): array {
		// STUB: Implement pub-forms-accessible test
		...
		//
		// KB Article: https://wpshadow.com/kb/pub-forms-accessible
	...
	public static function check(): ?array {
		...
		return \WPShadow\Core\Diagnostic_Lean_Checks::build_finding(
			'pub-forms-accessible',
			'Pub Forms Accessible',
			'Automatically initialized lean diagnostic for Pub Forms Accessible. Optimized for minimal overhead while surfacing high-value signals.',
			'general',
			'low',
			30,
			'pub-forms-accessible'
	 ...
	 * - Description: Automatically initialized lean diagnostic for Pub Forms Accessible. Optimized for minimal overhead while surfacing high-value signals.
	 *
	 * @return array {
