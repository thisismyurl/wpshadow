<?php
/**
 * SSL Certificate Configuration Diagnostic
 *
...
/**
 * Diagnostic: SSL Certificate Configuration
 *
 * Detects SSL configuration issues and validity.
 */
class Diagnostic_SSL_Certificate_Configuration extends Diagnostic_Base {
