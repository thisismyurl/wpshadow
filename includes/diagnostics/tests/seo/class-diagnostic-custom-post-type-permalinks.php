<?php
/**
 * Custom Post Type Permalinks Diagnostic
 *
...
/**
 * Custom Post Type Permalinks Diagnostic Class
 *
	...
	public static function check() {
		...
		if ( ! empty( $issues ) ) {
			return array(
				...
				'kb_link'      => 'https://wpshadow.com/kb/custom-post-type-permalinks?utm_source=wpshadow&utm_medium=plugin&utm_campaign=kb_diagnostics',
			);
		}
