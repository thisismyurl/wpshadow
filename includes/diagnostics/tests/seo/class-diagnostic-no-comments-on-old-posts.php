<?php
/**
 * No Comments on Old Posts Diagnostic
 *
...
/**
 * No Comments on Old Posts Diagnostic Class
 *
 ...
 * @since 0.6093.1200
 */
class Diagnostic_No_Comments_On_Old_Posts extends Diagnostic_Base {
	...
	public static function check() {
		...
		return array(
			...
			'threat_level' => 40,
			'auto_fixable' => false,
			'kb_link'      => 'https://wpshadow.com/kb/content-engagement?utm_source=wpshadow&utm_medium=plugin&utm_campaign=kb_diagnostics',
			'details'      => array(
