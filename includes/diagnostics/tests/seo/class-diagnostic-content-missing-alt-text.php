<?php
/**
 * Content Missing Alt Text Diagnostic
 *
...
/**
 * Content Missing Alt Text Diagnostic Class
 *
 ...
 * @since 0.6093.1200
 */
class Diagnostic_Content_Missing_Alt_Text extends Diagnostic_Base {
	...
	public static function check() {
		...
		if ( $missing_alt ) {
			$issues[] = __( 'Images without alt text fail WCAG1.0 accessibility requirement', 'wpshadow' );
		}
		...
		if ( ! empty( $issues ) ) {
			return array(
				...
				'threat_level' => 75,
				'auto_fixable' => true,
				'kb_link'      => 'https://wpshadow.com/kb/content-missing-alt-text?utm_source=wpshadow&utm_medium=plugin&utm_campaign=kb_diagnostics',
			);
		}
