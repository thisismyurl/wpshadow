 ...
 */
class Diagnostic_Social_Profile_Links_Reviewed extends Diagnostic_Base {
	 ...
	 * @var string
	 */
	protected static $slug = 'social-profile-links-reviewed';
	 ...
	 * @var string
	 */
	protected static $title = 'Social Profile Links Reviewed';
	 ...
	 * @var string
	 */
	protected static $description = 'TODO: Implement diagnostic logic for Social Profile Links Reviewed';
