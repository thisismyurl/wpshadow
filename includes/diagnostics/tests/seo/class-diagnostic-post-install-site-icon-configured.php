...
/**
 * Diagnostic_Post_Install_Site_Icon_Configured Class
 *
 * TODO: Implement full test logic and remediation guidance.
 */
class Diagnostic_Post_Install_Site_Icon_Configured extends Diagnostic_Base {
...
\t * @var string
\t */
\tprotected static $slug = 'post-install-site-icon-configured';
