<?php
/**
 * Long-Form Content Focus Diagnostic
 *
...
/**
 * Long-Form Content Focus Diagnostic Class
 *
 ...
 * @since 0.6093.1200
 */
class Diagnostic_Publishes_Long_Form_Content extends Diagnostic_Base {
	...
	public static function check() {
		...
		return array(
			...
			'auto_fixable' => false,
			'kb_link'      => 'https://wpshadow.com/kb/long-form-content?utm_source=wpshadow&utm_medium=plugin&utm_campaign=kb_diagnostics',
			'details'      => array(
