 ...
 */
class Diagnostic_Form_Error_Messaging_Reviewed extends Diagnostic_Base {
	 ...
	 * @var string
	 */
	protected static $slug = 'form-error-messaging-reviewed';
	 ...
	 * @var string
	 */
	protected static $title = 'Form Error Messaging Reviewed';
	 ...
	 * @var string
	 */
	protected static $description = 'TODO: Implement diagnostic logic for Form Error Messaging Reviewed';
