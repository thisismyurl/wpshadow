 ...
 */
class Diagnostic_Motion_Reduction_Reviewed extends Diagnostic_Base {
	 ...
	 * @var string
	 */
	protected static $slug = 'motion-reduction-reviewed';
	 ...
	 * @var string
	 */
	protected static $title = 'Reduced Motion Support Reviewed';
	 ...
	 * @var string
	 */
	protected static $description = 'TODO: Implement diagnostic logic for Reduced Motion Support Reviewed';
