	...
	public static function check() {
		...
		if ( ! is_dir( $wp_content_dir ) ) {
			return array(
				...
				'threat_level' => 90,
				'auto_fixable' => false,
				'kb_link'     => 'https://wpshadow.com/kb/wp-content-directory-missing?utm_source=wpshadow&utm_medium=plugin&utm_campaign=kb_diagnostics',
			);
		}
		...
		if ( ! is_writable( $wp_content_dir ) ) {
			...
			return array(
				...
				'threat_level' => 80,
				'auto_fixable' => false,
				'kb_link'     => 'https://wpshadow.com/kb/fix-wp-content-permissions?utm_source=wpshadow&utm_medium=plugin&utm_campaign=kb_diagnostics',
				'meta'        => array(
