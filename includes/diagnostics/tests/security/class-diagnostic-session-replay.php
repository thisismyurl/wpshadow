<?php
/**
 * Session Replay Attacks Diagnostic
 *
...
/**
 * Session Replay Attacks Diagnostic Class
 *
 ...
 * @since 0.6093.1200
 */
class Diagnostic_Session_Replay extends Diagnostic_Base {
	...
	public static function check() {
		...
		if ( $score < 65 ) {
			...
			return array(
				...
				'auto_fixable' => false,
				'kb_link'      => 'https://wpshadow.com/kb/session-replay-attacks?utm_source=wpshadow&utm_medium=plugin&utm_campaign=kb_diagnostics',
				'context'      => array(
					'stats'    => $stats,
					'issues'   => $issues,
					'warnings' => $warnings,
