...
/**
 * Diagnostic_Post_Install_Db_Creds_Not_Public Class
 *
 * TODO: Implement full test logic and remediation guidance.
 */
class Diagnostic_Post_Install_Db_Creds_Not_Public extends Diagnostic_Base {
...
\t * @var string
\t */
\tprotected static $slug = 'post-install-db-creds-not-public';
