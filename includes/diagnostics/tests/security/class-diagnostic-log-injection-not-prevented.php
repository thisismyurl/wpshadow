...
class Diagnostic_Log_Injection_Not_Prevented extends Diagnostic_Base {
	...
	public static function check() {
		if ( ! has_filter( 'init', 'sanitize_log_entries' ) ) {
			return array(
				'id'           => self::$slug,
				'title'        => self::$title,
				'description'  => __( 'Log injection not prevented. Sanitize user input before logging and use structured logging formats.', 'wpshadow' ),
				'severity'     => 'medium',
				'threat_level' => 40,
				'auto_fixable' => true,
				'kb_link'      => 'https://wpshadow.com/kb/log-injection-not-prevented?utm_source=wpshadow&utm_medium=plugin&utm_campaign=kb_diagnostics',
			);
		}
