<?php
/**
 * Failed Login Attempts Diagnostic
 *
...
/**
 * Diagnostic_Failed_Login_Attempts Class
 *
	...
	public static function check() {
		...
		if ( $failed_count >= 50 ) {
			return array(
				...
				'threat_level' => 80,
				'auto_fixable' => false,
				'kb_link'      => 'https://wpshadow.com/kb/failed-login-attempts?utm_source=wpshadow&utm_medium=plugin&utm_campaign=kb_diagnostics',
				'meta'         => array(
