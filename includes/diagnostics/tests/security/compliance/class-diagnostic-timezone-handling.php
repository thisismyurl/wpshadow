...
/**
 * Diagnostic_Timezone_Handling Class
 *
 * @since 0.6093.1200
 */
class Diagnostic_Timezone_Handling extends Diagnostic_Base {
	...
	public static function check() {
		...
		if ( ! empty( $issues ) ) {
			return array(
				...
				'threat_level' => 50,
				'auto_fixable' => true,
				'kb_link'      => 'https://wpshadow.com/kb/timezone-handling?utm_source=wpshadow&utm_medium=plugin&utm_campaign=kb_diagnostics',
				'details'      => array(
