<?php
/**
 * Session Timeout Configuration Diagnostic
 *
...
/**
 * Session Timeout Configuration Diagnostic Class
 *
 * Checks for:
	...
	public static function check() {
		...
		if ( ! empty( $issues ) ) {
			$finding = array(
				...
				'threat_level' => 75,
				'auto_fixable' => false,
				'kb_link'      => 'https://wpshadow.com/kb/session-timeout?utm_source=wpshadow&utm_medium=plugin&utm_campaign=kb_diagnostics',
				'context'      => array(
					'issues' => $issues,
