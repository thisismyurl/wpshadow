<?php
/**
 * User Input Not Sanitized Diagnostic
 *
...
/**
 * User Input Not Sanitized Diagnostic Class
 *
	...
	public static function check() {
		...
		if ( ! empty( $all_issues ) ) {
			...
			return array(
				...
				'threat_level' => 90,
				'auto_fixable' => false,
				'kb_link'      => 'https://wpshadow.com/kb/input-sanitization?utm_source=wpshadow&utm_medium=plugin&utm_campaign=kb_diagnostics',
				'meta'         => array(
