<?php
/**
 * HTTPS Redirect Working Diagnostic
 *
...
/**
 * Diagnostic_HTTPS_Redirect_Working Class
 *
 * Checks that HTTP requests redirect to HTTPS when HTTPS is supported.
 *
 * @since 0.6093.1200
 */
class Diagnostic_HTTPS_Redirect_Working extends Diagnostic_Base {
	...
	public static function check() {
		if ( ! wp_is_https_supported() ) {
			return array(
				...
				'threat_level' => 80,
				'auto_fixable' => false,
				'kb_link'      => 'https://wpshadow.com/kb/https-redirect-working?utm_source=wpshadow&utm_medium=plugin&utm_campaign=kb_diagnostics',
			);
		}
