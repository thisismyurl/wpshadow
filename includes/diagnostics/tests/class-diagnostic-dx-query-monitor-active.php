 ...
 * ==============================
 *
 * Question to Answer: Is Query Monitor helpful?
 *
 * Category: Developer Experience
 ...
 * Automatically initialized lean diagnostic for Dx Query Monitor Active. Optimized for minimal overhea...
 */
 ...
 * ================================================
 *
 * Question: Is Query Monitor helpful?
 * Slug: dx-query-monitor-active
 * Category: Developer Experience
 *
	...
	public static function check(): ?array {
		...
		if ( ! is_plugin_active( 'query-monitor/query-monitor.php' ) ) {
			return \WPShadow\Core\Diagnostic_Lean_Checks::build_finding(
				...
				'Dx Query Monitor Active',
				'Query Monitor plugin not active. Install and activate Query Monitor for advanced debugging and performance analysis.',
				'dx',
				'low',
				20,
				'dx-query-monitor-active'
