...
class Diagnostic_Monitor_SQL_Injection_Attempts extends Diagnostic_Base {
	...
	public static function check(): ?array {
		...
		return array(
			'id'            => 'monitor-sql-injection',
			'title'         => __( 'SQL Injection Monitoring Not Active', 'wpshadow' ),
			'description'   => __( 'No security plugin monitoring SQL injection attempts. Install Wordfence or similar.', 'wpshadow' ),
			'severity'      => 'low',
			'category'      => 'monitoring',
