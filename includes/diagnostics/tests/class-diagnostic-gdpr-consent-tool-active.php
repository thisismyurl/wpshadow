 ...
 * ================================================
 *
 * Question: Is cookie consent banner active?
 * Slug: gdpr-consent-tool-active
 * Category: Compliance & Legal Risk
 *
...
class Diagnostic_Gdpr_Consent_Tool_Active extends Diagnostic_Base {
	...
	public static function check(): ?array {
		// Check if GDPR consent management tool is active
		$consent_plugins = [
		...
		if ( ! $has_consent_tool ) {
			return \WPShadow\Core\Diagnostic_Lean_Checks::build_finding(
				...
				'Gdpr Consent Tool Active',
				'No GDPR consent management tool detected. Install a cookie consent plugin to manage user preferences and comply with GDPR requirements.',
				'security',
				'high',
				75,
				'gdpr-consent-tool-active'
