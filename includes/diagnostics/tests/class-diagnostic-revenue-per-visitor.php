...
class Diagnostic_Revenue_Per_Visitor extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Revenue Per Visitor
	 ...
	 * - Description: Automatically initialized lean diagnostic for Revenue Per Visitor. Optimized for minimal overhead while surfacing high-value signals.
	 *
	 * @return array {
	 ...
	 * }
	 */
	public static function test_live_revenue_per_visitor(): array {
		/*
