<?php
/**
 * Diagnostic: Tap Target Size Validation
 *
 ...
 * @since 1.6034.1440
 */
class Diagnostic_Mobile_Tap_Target_Size extends Diagnostic_Base {
	 ...
	 *
	 * This diagnostic checks theme CSS for minimum touch target sizes.
