...
/**
 * Post Meta Query Performance Diagnostic Class
 *
	...
	public static function check() {
		...
		if ( ! empty( $issues ) ) {
			return array(
				...
				'threat_level' => 60,
				'auto_fixable' => false,
				'kb_link'     => 'https://wpshadow.com/kb/post-meta-query-performance?utm_source=wpshadow&utm_medium=plugin&utm_campaign=kb_diagnostics',
			);
		}
