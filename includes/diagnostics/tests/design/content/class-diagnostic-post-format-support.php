<?php
/**
 * Post Format Support Diagnostic
 *
...
/**
 * Post Format Support Diagnostic Class
 *
 ...
 * @since 0.6093.1200
 */
class Diagnostic_Post_Format_Support extends Diagnostic_Base {
	...
	public static function check() {
		...
		if ( ! empty( $issues ) ) {
			return array(
				...
				'threat_level' => 35,
				'auto_fixable' => false,
				'kb_link'      => 'https://wpshadow.com/kb/post-format-support?utm_source=wpshadow&utm_medium=plugin&utm_campaign=kb_diagnostics',
			);
		}
