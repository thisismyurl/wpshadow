 ...
 */
class Diagnostic_Mobile_Menu_Reviewed extends Diagnostic_Base {
	 ...
	 * @var string
	 */
	protected static $slug = 'mobile-menu-reviewed';
	 ...
	 * @var string
	 */
	protected static $title = 'Mobile Menu Reviewed';
	 ...
	 * @var string
	 */
	protected static $description = 'TODO: Implement diagnostic logic for Mobile Menu Reviewed';
