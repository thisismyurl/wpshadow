	...
	public static function check() {
		...
		if ( ! function_exists( 'wp_mail' ) ) {
			return array(
				...
				'threat_level' => 85,
				'auto_fixable' => false,
				'kb_link'      => 'https://wpshadow.com/kb/gdpr-export-email-delivery?utm_source=wpshadow&utm_medium=plugin&utm_campaign=kb_diagnostics',
			);
		}
		...
		if ( $from_email ) {
			$domain = Diagnostic_URL_And_Pattern_Helper::get_domain( get_site_url() );
