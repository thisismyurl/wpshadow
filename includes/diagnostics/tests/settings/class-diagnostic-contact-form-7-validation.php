<?php
/**
 * Contact Form 7 Form Field Validation and Security Diagnostic
 *
...
/**
 * Contact Form 7 Validation Diagnostic Class
 *
...
class Diagnostic_Contact_Form_7_Validation extends Diagnostic_Base {
	...
	public static function check() {
		...
		return array(
			...
			'auto_fixable' => false,
			'details'      => $issues,
			'kb_link'      => 'https://wpshadow.com/kb/contact-form-7-validation?utm_source=wpshadow&utm_medium=plugin&utm_campaign=kb_diagnostics',
		);
	}
