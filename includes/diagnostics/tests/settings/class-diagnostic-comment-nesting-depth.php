<?php
/**
 * Comment Nesting Depth Diagnostic
 *
...
/**
 * Comment Nesting Depth Diagnostic Class
 *
 * Checks comment threading/nesting configuration.
 *
 * @since 0.6093.1200
 */
class Diagnostic_Comment_Nesting_Depth extends Diagnostic_Base {
	...
	public static function check() {
		...
		if ( ! empty( $issues ) ) {
			return array(
				...
				'threat_level' => 25,
				'auto_fixable' => false,
				'kb_link'      => 'https://wpshadow.com/kb/comment-nesting-depth?utm_source=wpshadow&utm_medium=plugin&utm_campaign=kb_diagnostics',
			);
		}
