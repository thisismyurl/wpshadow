...
/**
 * Diagnostic_Post_Install_Pingbacks_Trackbacks_Policy Class
 *
 * TODO: Implement full test logic and remediation guidance.
 */
class Diagnostic_Post_Install_Pingbacks_Trackbacks_Policy extends Diagnostic_Base {
...
\t * @var string
\t */
\tprotected static $slug = 'post-install-pingbacks-trackbacks-policy';
