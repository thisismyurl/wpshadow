<?php
/**
 * Comment Author Whitelist Diagnostic
 *
...
/**
 * Comment Author Whitelist Diagnostic Class
 *
 * Checks comment approval whitelist configuration.
 *
 * @since 0.6093.1200
 */
class Diagnostic_Comment_Author_Whitelist extends Diagnostic_Base {
	...
	public static function check() {
		...
		$whitelist_enabled = get_option( 'comment_previously_approved', 1 );
		...
		if ( ! empty( $issues ) ) {
			return array(
				...
				'threat_level' => 30,
				'auto_fixable' => false,
				'kb_link'      => 'https://wpshadow.com/kb/comment-author-whitelist?utm_source=wpshadow&utm_medium=plugin&utm_campaign=kb_diagnostics',
			);
		}
