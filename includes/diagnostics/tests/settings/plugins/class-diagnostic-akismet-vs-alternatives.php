...
class Diagnostic_AkismetVsAlternatives extends Diagnostic_Base {
	protected static $slug = 'akismet-vs-alternatives';
	protected static $title = 'Akismet vs Alternatives';
	...
	public static function check() {
		...
		if ( $spam_count < 100 ) {
			return array(
				'id' => self::$slug,
				'title' => self::$title,
				'description' => sprintf( __( 'Low spam volume (%d) - consider free alternatives', 'wpshadow' ), $spam_count ),
				'severity' => 'medium',
				'threat_level' => 30,
				'auto_fixable' => false,
				'kb_link' => 'https://wpshadow.com/kb/akismet-alternatives',
			);
		}
