...
class Diagnostic_Pub_Keyword_In_Headings extends Diagnostic_Base {
	...
	protected static $title = 'Pub Keyword In Headings';

	protected static $description = 'Automatically initialized lean diagnostic for Pub Keyword In Headings. Optimized for minimal overhead while surfacing high-value signals.';
	...
	public static function check(): ?array {
		...
		return \WPShadow\Core\Diagnostic_Lean_Checks::build_finding(
			'pub-keyword-in-headings',
			'Pub Keyword In Headings',
			'Automatically initialized lean diagnostic for Pub Keyword In Headings. Optimized for minimal overhead while surfacing high-value signals.',
			'general',
			'low',
			30,
			'pub-keyword-in-headings'
	 ...
	 * - Description: Automatically initialized lean diagnostic for Pub Keyword In Headings. Optimized for minimal overhead while surfacing high-value signals.
	 *
	 * @return array {
