...
class Test_Performance_Preconnect_DNS_Prefetch extends Diagnostic_Base {
	...
	protected static function analyze_html( string $html, string $checked_url ): ?array {
		...
		$external_hosts = array_diff( $external_hosts, array( $site_host ) );
		...
		$major_third_parties = array( 'fonts.googleapis.com', 'fonts.gstatic.com', 'www.google-analytics.com', 'www.googletagmanager.com', 'cdn.jsdelivr.net' );
