...
class Diagnostic_Retention_Nps_Score extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Retention Nps Score
	 ...
	 * - Description: Automatically initialized lean diagnostic for Retention Nps Score. Optimized for minimal overhead while surfacing high-value signals.
	 *
	 * @return array {
	 ...
	 * }
	 */
	public static function test_live_retention_nps_score(): array {
		/*
