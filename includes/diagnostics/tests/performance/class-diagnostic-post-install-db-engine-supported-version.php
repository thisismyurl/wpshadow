...
/**
 * Diagnostic_Post_Install_Db_Engine_Supported_Version Class
 *
 * TODO: Implement full test logic and remediation guidance.
 */
class Diagnostic_Post_Install_Db_Engine_Supported_Version extends Diagnostic_Base {
...
\t * @var string
\t */
\tprotected static $slug = 'post-install-db-engine-supported-version';
