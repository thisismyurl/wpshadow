<?php
/**
 * Permalink Structure Not Optimized Diagnostic
 *
...
/**
 * Permalink Structure Not Optimized Diagnostic Class
 *
 * Tests for SEO-friendly permalink structure.
 *
 * @since 0.6093.1200
 */
class Diagnostic_Permalink_Structure_Not_Optimized extends Diagnostic_Base {
	...
	public static function check() {
		...
		if ( ! empty( $issues ) ) {
			return array(
				...
				'threat_level' => 30,
				'auto_fixable' => true,
				'kb_link'      => 'https://wpshadow.com/kb/permalink-structure-not-optimized?utm_source=wpshadow&utm_medium=plugin&utm_campaign=kb_diagnostics',
			);
		}
