...
/**
 * Diagnostic_Post_Install_Page_Cache_Active Class
 *
 * TODO: Implement full test logic and remediation guidance.
 */
class Diagnostic_Post_Install_Page_Cache_Active extends Diagnostic_Base {
...
\t * @var string
\t */
\tprotected static $slug = 'post-install-page-cache-active';
