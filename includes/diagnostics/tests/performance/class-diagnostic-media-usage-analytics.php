<?php
/**
 * Media Usage Analytics Diagnostic
 *
...
/**
 * Media Usage Analytics Diagnostic Class
 *
 * Verifies ability to track and report on which posts/pages use specific media.
 *
 * @since 0.6093.1200
 */
class Diagnostic_Media_Usage_Analytics extends Diagnostic_Base {
	...
	public static function check() {
		...
		if ( ! empty( $issues ) ) {
			return array(
				...
				'threat_level' => 40,
				'auto_fixable' => false,
				'kb_link'      => 'https://wpshadow.com/kb/media-usage-analytics?utm_source=wpshadow&utm_medium=plugin&utm_campaign=kb_diagnostics',
			);
		}
