...
class Diagnostic_No_Retry_Mechanism_For_Failed_Tool_Operations extends Diagnostic_Base {
	...
	public static function check() {
		...
		$scheduled_retries = wp_next_scheduled( 'wpshadow_retry_failed_operations' );
		...
		if ( ! empty( $issues ) ) {
			return array(
				...
				'threat_level' => 50,
				'auto_fixable' => true,
				'kb_link'      => 'https://wpshadow.com/kb/no-retry-mechanism-for-failed-tool-operations?utm_source=wpshadow&utm_medium=plugin&utm_campaign=kb_diagnostics',
			);
		}
