...
/**
 * Comment Revision Accumulation Diagnostic Class
 *
	...
	public static function check() {
		...
		if ( $revision_meta > 100 ) {
			return array(
				...
				'threat_level' => 30,
				'auto_fixable' => false,
				'kb_link'      => 'https://wpshadow.com/kb/comment-revision-accumulation?utm_source=wpshadow&utm_medium=plugin&utm_campaign=kb_diagnostics',
			);
		}
