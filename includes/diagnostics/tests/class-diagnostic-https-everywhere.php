 ...
 * ==============================
 *
 * Question to Answer: Are all pages HTTPS?
 *
 * Category: Compliance & Legal Risk
 ...
 * Automatically initialized lean diagnostic for Https Everywhere. Optimized for minimal overhead while...
 */
...
class Diagnostic_Https_Everywhere extends Diagnostic_Base {
	...
	public static function check(): ?array {
		...
		return \WPShadow\Core\Diagnostic_Lean_Checks::build_finding(
			'https-everywhere',
			'Https Everywhere',
			'Your site is not using HTTPS for all pages. HTTPS is required for security and compliance.',
			'security',
			'critical',
			90,
			'https-everywhere'
	 ...
	 * - Description: Automatically initialized lean diagnostic for Https Everywhere. Optimized for minimal overhead while surfacing high-value signals.
	 *
	 * @return array {
	 ...
	 * }
	 */
	public static function test_live_https_everywhere(): array {
		/*
