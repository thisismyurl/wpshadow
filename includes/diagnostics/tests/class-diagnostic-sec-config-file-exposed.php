...
class Diagnostic_SecConfigFileExposed extends Diagnostic_Base {
	 ...
	 *
	 * Diagnostic: Sec Config File Exposed
	 ...
	 * - Description: Automatically initialized lean diagnostic for Sec Config File Exposed. Optimized for minimal overhead while surfacing high-value signals.
	 *
	 * @return array {
	 ...
	 * }
	 */
	public static function test_live_sec_config_file_exposed(): array {
		/*
		 * IMPLEMENTATION NOTES:
