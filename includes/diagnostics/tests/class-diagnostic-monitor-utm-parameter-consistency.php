...
class Diagnostic_Monitor_Utm extends Diagnostic_Base {
	public static function check(): ?array {
		return array(
			'id'            => 'monitor-utm_parameter_consistency',
			'title'         => __( 'UTM Parameter Consistency', 'wpshadow' ),
			'description'   => __( 'Monitors UTM naming conventions. Inconsistency = analytics mess.', 'wpshadow' ),
			'severity'      => 'medium',
			'category'      => 'monitoring',
	...
	public static function test_live__monitor_utm_parameter_consistency(): array {
		...
		if ( $result === null ) {
			return array(
				'passed'  => true,
				'message' => 'UTM parameters are consistent and traceable',
			);
		}
