...
/**
 * WPShadow Diagnostic Test: JavaScript Asset Version Strings
 *
 * Detects JavaScript enqueues that use version query strings (?ver=), which can be removed
 * to improve caching consistency and reduce cache fragmentation.
 *
...
class Test_Asset_Versions_JS extends Diagnostic_Base
{
	...
	public static function get_info(): array
	{
		return array(
			...
			'category'    => 'performance',
			'severity'    => 'low',
			'description' => 'Detects JavaScript files using ?ver= cache-busting query strings.',
		);
	}
}
