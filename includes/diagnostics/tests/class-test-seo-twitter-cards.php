...
class Test_SEO_Twitter_Cards extends Diagnostic_Base {
	 ...
	 */
	const REQUIRED_TAGS    = array( 'twitter:card' );
	const RECOMMENDED_TAGS = array( 'twitter:title', 'twitter:description', 'twitter:image' );
	const OPTIONAL_TAGS    = array( 'twitter:site', 'twitter:creator' );

	/**
	 * Valid card types
	 */
	const VALID_CARD_TYPES = array( 'summary', 'summary_large_image', 'app', 'player' );
