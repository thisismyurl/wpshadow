 ...
 * ==============================
 *
 * Question to Answer: Is consent collected before tracking?
 *
 * Category: Compliance & Legal Risk
 * Slug: gdpr-consent-before-tracking
 *
 * Purpose:
 * Determine if the WordPress site meets Compliance & Legal Risk criteria related to:
 * Automatically initialized lean diagnostic for Gdpr Consent Before Tracking. Optimized for minimal ov...
 */
 ...
 * ================================================
 *
 * Question: Is consent collected before tracking?
 * Slug: gdpr-consent-before-tracking
 * Category: Compliance & Legal Risk
 *
...
class Diagnostic_Gdpr_Consent_Before_Tracking extends Diagnostic_Base {
	...
	public static function check(): ?array {
		// Check if consent is obtained before tracking (Google Analytics, etc.)

		// Check if Google Analytics is active without consent management
		$has_analytics = is_plugin_active( 'google-analytics-dashboard-for-wp/gadwp.php' ) ||
						is_plugin_active( 'monsterinsights/monsterinsights.php' ) ||
						is_plugin_active( 'googleanalytics/googleanalytics.php' );
		...
		// Flag if analytics active but no consent management
		if ( $has_analytics && ! $has_consent ) {
			return \WPShadow\Core\Diagnostic_Lean_Checks::build_finding(
				'gdpr-consent-before-tracking',
				'Gdpr Consent Before Tracking',
				'Analytics tracking detected without consent management. Ensure users provide explicit consent before tracking is enabled.',
				'security',
				'high',
				75,
				'gdpr-consent-before-tracking'
	 ...
	 *
	 * Diagnostic: Gdpr Consent Before Tracking
	 * Slug: gdpr-consent-before-tracking
	 *
	 * Test Purpose:
	 ...
	 * - Description: Automatically initialized lean diagnostic for Gdpr Consent Before Tracking. Optimized for minimal overhead while surfacing high-value signals.
	 *
	 * @return array {
	 ...
	 * }
	 */
	public static function test_live_gdpr_consent_before_tracking(): array {
		/*
