...
class WPSHADOW_Hidden_Diagnostic_API {
	...
	public static function render_support_page(): void {
		...
		?>
		<div class="wrap">
			<h1><?php esc_html_e( 'Support Access Control', 'wpshadow' ); ?></h1>
			<p><?php esc_html_e( 'Create secure access tokens for support to diagnose issues without admin credentials.', 'wpshadow' ); ?></p>

			<div style="margin: 20px 0;">
				<h3><?php esc_html_e( 'Create New Token', 'wpshadow' ); ?></h3>
				<form id="wps-create-token" style="max-width: 500px;">
					<div style="margin: 10px 0;">
						<label><?php esc_html_e( 'Support Agent Name', 'wpshadow' ); ?></label><br/>
					<input type="text" name="support_name" placeholder="e.g., WPShadow Support" style="width: 100%; padding: 8px; margin: 5px 0;">
					</div>
					<div style="margin: 10px 0;">
						<label><?php esc_html_e( 'Reason for Access', 'wpshadow' ); ?></label><br/>
					...
					<button type="submit" class="button button-primary">
						<?php esc_html_e( '🔐 Create Token (24hr expiry)', 'wpshadow' ); ?>
					</button>
				</form>
			</div>

			<?php if ( ! empty( $tokens ) ) : ?>
				<h3><?php esc_html_e( 'Active Tokens', 'wpshadow' ); ?></h3>
				<table class="wp-list-table widefat striped">
					<thead>
						<tr>
							<th><?php esc_html_e( 'Created', 'wpshadow' ); ?></th>
							<th><?php esc_html_e( 'Support Agent', 'wpshadow' ); ?></th>
							<th><?php esc_html_e( 'Reason', 'wpshadow' ); ?></th>
							<th><?php esc_html_e( 'Expires', 'wpshadow' ); ?></th>
							<th><?php esc_html_e( 'Uses', 'wpshadow' ); ?></th>
							<th><?php esc_html_e( 'Token', 'wpshadow' ); ?></th>
