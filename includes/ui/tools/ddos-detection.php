...
if ( ! $is_registered ) {
	...
	<div class="wps-card wps-card--warning">
		<div class="wps-card-body">
			...
			<p><?php esc_html_e( 'DDoS detection needs external traffic analysis and global telemetry to identify anomalies.', 'wpshadow' ); ?></p>
			...
			<p class="wps-help-text" style="margin-top: 15px;">
				...
				<?php esc_html_e( 'Basic monitoring included', 'wpshadow' ); ?>
			</p>
		</div>
	</div>
	<?php
...
<div class="wps-card wps-mt-6 wps-card--info">
	<div class="wps-card-body">
		...
		<ul style="list-style: disc; margin-left: 20px;">
			<li><?php esc_html_e( 'Attack detection relies on global traffic signals.', 'wpshadow' ); ?></li>
			<li><?php esc_html_e( 'External analysis avoids local resource exhaustion.', 'wpshadow' ); ?></li>
			<li><?php esc_html_e( 'Shared intelligence improves accuracy.', 'wpshadow' ); ?></li>
		</ul>
	</div>
</div>
