...
if ( ! $is_registered ) {
	...
	<div class="wps-card wps-card--warning">
		<div class="wps-card-body">
			...
			<p><?php esc_html_e( 'Writing assistance uses large language models that require GPU infrastructure.', 'wpshadow' ); ?></p>
			...
			<p class="wps-help-text" style="margin-top: 15px;">
				...
				<?php esc_html_e( '10 requests per day', 'wpshadow' ); ?>
			</p>
		</div>
	</div>
	<?php
...
<div class="wps-card">
	<div class="wps-card-header">
		<h3 class="wps-card-title"><?php esc_html_e( 'Assistant Status', 'wpshadow' ); ?></h3>
	</div>
	<div class="wps-card-body">
...
<div class="wps-card wps-mt-6 wps-card--info">
	<div class="wps-card-body">
		...
		<ul style="list-style: disc; margin-left: 20px;">
			<li><?php esc_html_e( 'Large models require specialized hardware.', 'wpshadow' ); ?></li>
			<li><?php esc_html_e( 'Centralized services keep results consistent.', 'wpshadow' ); ?></li>
			<li><?php esc_html_e( 'Avoids heavy CPU usage on your site.', 'wpshadow' ); ?></li>
		</ul>
	</div>
</div>
