...
if ( ! $is_registered ) {
	...
	<div class="wps-card wps-card--warning">
		<div class="wps-card-body">
			...
			<p><?php esc_html_e( 'Keyword rankings require external search queries and distributed tracking.', 'wpshadow' ); ?></p>
			...
			<p class="wps-help-text" style="margin-top: 15px;">
				...
				<?php esc_html_e( 'Track up to 10 keywords', 'wpshadow' ); ?>
			</p>
		</div>
	</div>
	<?php
...
<div class="wps-card">
	<div class="wps-card-header">
		<h3 class="wps-card-title"><?php esc_html_e( 'Ranking Summary', 'wpshadow' ); ?></h3>
	</div>
	<div class="wps-card-body">
...
<div class="wps-card wps-mt-6 wps-card--info">
	<div class="wps-card-body">
		...
		<ul style="list-style: disc; margin-left: 20px;">
			<li><?php esc_html_e( 'Search engines block frequent local queries.', 'wpshadow' ); ?></li>
			<li><?php esc_html_e( 'External monitoring avoids IP bans.', 'wpshadow' ); ?></li>
			<li><?php esc_html_e( 'Daily tracking keeps trends accurate.', 'wpshadow' ); ?></li>
		</ul>
	</div>
</div>
