...
class TIMU_Notice_Manager {
	 ...
	 * @var string
	 */
	private const META_KEY = 'timu_dismissed_notices';
	...
	public static function init(): void {
		...
		add_action( 'wp_ajax_timu_dismiss_notice', array( __CLASS__, 'ajax_dismiss_notice' ) );
	}
	...
	public static function enqueue_dismissal_script(): void {
		...
		wp_localize_script(
			...
			array(
				...
				'nonce'   => wp_create_nonce( 'timu_dismiss_notice' ),
			)
		);
	}
	...
	public static function ajax_dismiss_notice(): void {
		check_ajax_referer( 'timu_dismiss_notice', 'nonce' );
