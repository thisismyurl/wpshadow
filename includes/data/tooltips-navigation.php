...
return [
	...
	[
		'id' => 'nav-wpshadow-tools',
		'selector' => '#menu-wpshadow li a[href*="page=wpshadow-tools"]',
		'title' => __( 'WPShadow Tools', 'wpshadow' ),
		'message' => __( 'Access specialized analysis tools including accessibility audits, link checks, and color contrast analysis.', 'wpshadow' ),
		'category' => 'navigation',
		'level' => 'beginner',
		'kb_url' => 'https://fictional-space-bassoon-qr65q7qqx4p2xvgr-9000.app.github.dev/kb/general-wpshadow-tools',
	],
	[
