...
class Settings_Registry
{
	...
	public static function register_all_settings(): void
	{
		...
		register_setting('wpshadow_guardian_settings', 'wpshadow_guardian_activity_logging', [
			'type' => 'boolean',
			'default' => true,
			'sanitize_callback' => 'rest_sanitize_boolean',
			'show_in_rest' => false,
		...
		register_setting('wpshadow_guardian_settings', 'wpshadow_guardian_max_treatments', [
			'type' => 'integer',
			'default' => 5,
			'sanitize_callback' => [__CLASS__, 'sanitize_max_treatments'],
			'show_in_rest' => false,
			'description' => __('Maximum treatments per Guardian run', 'wpshadow'),
		]);

		register_setting('wpshadow_guardian_settings', 'wpshadow_guardian_auto_fix_whitelist', [
			'type' => 'array',
			'default' => [],
			'sanitize_callback' => [__CLASS__, 'sanitize_treatment_whitelist'],
			'show_in_rest' => false,
		...
		register_setting('wpshadow_workflow_settings', 'wpshadow_email_verification_tokens', [
			'type' => 'array',
			'default' => [],
			'sanitize_callback' => [__CLASS__, 'sanitize_verification_tokens'],
		...
		register_setting('wpshadow_privacy_settings', 'wpshadow_telemetry_consent_date', [
			'type' => 'string',
			'default' => '',
		...
		register_setting('wpshadow_privacy_settings', 'wpshadow_error_reporting', [
			'type' => 'boolean',
		...
		register_setting('wpshadow_settings', 'wpshadow_cache_duration', [
			'type' => 'integer',
			'default' => 3600, // 1 hour
		...
		register_setting('wpshadow_settings', 'wpshadow_kb_link_enabled', [
			'type' => 'boolean',
		...
		register_setting('wpshadow_settings', 'wpshadow_training_link_enabled', [
			'type' => 'boolean',
		...
		register_setting('wpshadow_settings', 'wpshadow_heartbeat_settings', [
			'type' => 'array',
			'default' => [
				'dashboard' => 60,
				'editor' => 15,
			...
			'sanitize_callback' => [__CLASS__, 'sanitize_heartbeat_settings'],
			'show_in_rest' => false,
