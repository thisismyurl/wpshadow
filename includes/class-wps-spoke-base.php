<?php
/**
 * WPS Spoke Base Class - Reusable framework for all spoke plugins
 *
...
abstract class WPS_Spoke_Base {
	...
	private function load_components(): void {
		...
		$files = array(
			'vault'     => $dir . 'class-wps-vault-v1.php',
			'admin'     => $dir . 'class-wps-admin-v1.php',
			'ajax'      => $dir . 'class-wps-ajax-v1.php',
			'processor' => $dir . 'class-wps-processor-v1.php',
		);
					...
					<div id="post-body" class="metabox-holder columns-2">
						<div id="post-body-content">
							<?php foreach ( (array) $this->settings_blueprint as $section_id => $section ) : ?>
								<div class="wps-settings-section" style="margin-bottom:24px;">
