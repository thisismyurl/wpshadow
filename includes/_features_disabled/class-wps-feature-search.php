	...
	public static function enqueue_assets( string $hook ): void {
		...
		wp_localize_script(
			...
			array(
				...
				'searchLabel' => __( 'Search features...', 'wpshadow' ),
		...
		<div class="wpshadow-feature-search-wrapper">
			<div class="wpshadow-feature-search-container">
				<label for="wpshadow-feature-search-input" class="screen-reader-text">
					<?php esc_html_e( 'Search features', 'wpshadow' ); ?>
				</label>
				<input 
					type="text" 
				...
				<div id="wpshadow-search-results" class="wpshadow-search-results" role="listbox" aria-label="<?php esc_attr_e( 'Search results', 'wpshadow' ); ?>"></div>
			</div>

			<?php if ( $has_accessed ) : ?>
			<div class="wpshadow-commonly-accessed">
				<div class="wpshadow-commonly-accessed-header">
					<h3><?php esc_html_e( 'Commonly Accessed', 'wpshadow' ); ?></h3>
					<button 
						type="button" 
						class="wpshadow-clear-accessed" 
						aria-label="<?php esc_attr_e( 'Clear commonly accessed list', 'wpshadow' ); ?>"
						title="<?php esc_attr_e( 'Clear list', 'wpshadow' ); ?>"
					>
