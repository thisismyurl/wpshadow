...
return array(
	...
	'kb_article'     => \WPShadow\Core\UTM_Link_Manager::kb_link( 'notion-to-wordpress', 'onboarding' ),
	'training_video' => \WPShadow\Core\UTM_Link_Manager::academy_link( 'notion-to-wordpress', 'onboarding' ),
);
