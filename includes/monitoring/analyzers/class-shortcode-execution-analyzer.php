...
class Shortcode_Execution_Analyzer {
    ...
    public static function init(): void {
        ...
        add_filter('do_shortcode_tag', [__CLASS__, 'track_shortcode_execution'], 10, 4);
        
        // Save data on shutdown
        add_action('shutdown', [__CLASS__, 'save_execution_data']);
        ...
        add_action('wpshadow_analyze_shortcode_execution', [__CLASS__, 'analyze']);
    }
    ...
    public static function save_execution_data(): void {
        ...
        $stored = array_filter($stored, function($item) use ($one_day_ago) {
