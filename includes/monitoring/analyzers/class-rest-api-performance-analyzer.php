...
class REST_API_Performance_Analyzer {
    ...
    public static function init(): void {
        ...
        add_filter('rest_pre_dispatch', [__CLASS__, 'start_tracking'], 10, 3);
        add_filter('rest_post_dispatch', [__CLASS__, 'end_tracking'], 10, 3);
    }
        ...
        if (is_array($metrics)) {
            ...
            foreach ($metrics['requests'] as $req) {
                ...
                if (!isset($route_times[$route])) {
                    $route_times[$route] = array('total' => 0, 'count' => 0);
                }
