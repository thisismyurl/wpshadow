...
class Compromised_Accounts_Analyzer {
    ...
    public static function init(): void {
        ...
        add_action('set_user_role', [__CLASS__, 'track_role_change'], 10, 3);
        add_action('wp_update_user', [__CLASS__, 'track_user_update']);
        ...
        add_action('wpshadow_analyze_compromised_accounts', [__CLASS__, 'analyze']);
    }
    ...
    public static function analyze(): array {
        ...
        if (is_array($login_history)) {
            foreach ($login_history as $user_id => $logins) {
                ...
                $recent_logins = array_filter($logins, function($login) {
