...
├── includes/
│   ├── admin/                           # Admin UI (dashboard, widgets, assets, screens)
...
├── wpshadow-pro/                        # Pro addon (features, license, updates)
│   ├── includes/                        # Pro-specific includes
│   ├── assets/                          # Pro-specific assets
│   └── wpshadow-pro.php                # Pro bootstrap
...
- `wpshadow-pro/` - Pro addon features and integrations
