...
WPShadow handles site diagnostics, admin workflows, and remediation guidance, so security issues matter a great deal.
...
WPShadow follows these core expectations:
