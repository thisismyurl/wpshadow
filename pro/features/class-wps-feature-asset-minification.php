	...
	public function __construct() {
		parent::__construct(
			array(
				...
				'description'        => __( 'Make your pages load faster by compressing CSS and JavaScript files, then serves them in smaller bundles so pages download faster and start rendering sooner. Helps repeat visitors by lowering total bytes transferred, reduces bandwidth costs on heavy pages, and keeps behavior identical because it preserves functionality while trimming bloat. This works automatically once enabled and respects dependency order to avoid breaking features.', 'plugin-wpshadow' ),
				'scope'              => 'core',
