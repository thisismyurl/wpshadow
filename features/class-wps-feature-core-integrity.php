...
final class WPSHADOW_Feature_Core_Integrity extends WPSHADOW_Abstract_Feature {
	...
	public function __construct() {
		parent::__construct(
			array(
				'id'                 => 'core-integrity',
				'name'               => __( 'File Security Scanner', 'wpshadow' ),
				'description_short'  => __( 'Check if WordPress files have been tampered with', 'wpshadow' ),
				'description_long'   => __( 'Compares your WordPress files against the originals to spot any suspicious changes. Helps detect if someone broke into your site and modified files, or if malicious code was added. Can automatically fix changed files by downloading fresh copies from WordPress.org, keeping backups just in case. Runs checks regularly and alerts you if anything looks wrong.', 'wpshadow' ),
				'description_wizard' => __( 'Scan your WordPress files daily to make sure nobody has changed them without your permission. Catches hackers who try to sneak bad code into your site.', 'wpshadow' ),
