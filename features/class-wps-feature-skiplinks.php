			...
			array(
				...
				'sub_features'       => array(
					'skip_to_content'     => array(
						...
						'description'         => __( 'Add skip link to main content area.', 'wpshadow' ),
						'default_enabled'     => true,
					),
					'skip_to_nav'         => array(
						...
						'description'         => __( 'Add skip link to main navigation menu.', 'wpshadow' ),
						'default_enabled'     => true,
					),
					'skip_to_footer'      => array(
						...
						'description'         => __( 'Add skip link to footer section.', 'wpshadow' ),
					...
					'custom_styling'      => array(
						...
						'description'         => __( 'Apply custom visual styling to skip links.', 'wpshadow' ),
						'default_enabled'     => true,
					),
				),
			)
