...
final class WPSHADOW_Feature_Core_Diagnostics extends WPSHADOW_Abstract_Feature {
	...
	public function __construct() {
		parent::__construct(
			array(
				'id'                 => 'core-diagnostics',
				'name'               => __( 'System Diagnostics', 'wpshadow' ),
				'description_short'  => __( 'Comprehensive WordPress system health monitoring', 'wpshadow' ),
				'description_long'   => __( 'Advanced diagnostic system that continuously monitors critical WordPress infrastructure components. Performs automated checks on core updates availability, PHP version compatibility, database health metrics, file permission security, HTTP security headers, debug mode configuration, error log sizes, and SSL/HTTPS setup. Provides severity-based alerting, scheduled monitoring, detailed reporting, and actionable recommendations. Integrates with WordPress Site Health API and includes customizable check intervals, alert thresholds, and admin dashboard notices for critical issues.', 'wpshadow' ),
				'description_wizard' => __( 'Enable comprehensive system diagnostics to automatically monitor your WordPress installation for potential issues, security problems, and configuration errors. Get alerts before problems become critical.', 'wpshadow' ),
