...
final class WPSHADOW_Feature_Iframe_Busting extends WPSHADOW_Abstract_Feature {
			...
			array(
				...
				'sub_features'       => array(
					'csp_header'         => array(
						...
						'description'         => __( 'Add CSP frame-ancestors header (recommended).', 'wpshadow' ),
					...
					'xfo_header'         => array(
						...
						'description'         => __( 'Add X-Frame-Options header for old browsers.', 'wpshadow' ),
						'default_enabled'     => true,
					),
					'js_framebuster'     => array(
						...
						'description'         => __( 'Add JavaScript frame-breaking code (fallback).', 'wpshadow' ),
						'default_enabled'     => true,
					),
				),
			)
	...
	public function add_security_headers(): void {
		...
		$policy = 'sameorigin'; // Default policy
