<?php
/**
 * Asset Version Removal - Remove JS Versions
 *
...
final class WPSHADOW_Feature_Asset_Version_Removal_Remove_JS extends WPSHADOW_Abstract_Feature {

	public function __construct() {
		parent::__construct(
			array(
				'id'                 => 'asset-version-removal-remove-js',
				'name'               => __( 'Remove JavaScript Versions', 'plugin-wpshadow' ),
				'description'        => __( 'Strip version query strings from enqueued scripts to improve caching.', 'plugin-wpshadow' ),
				'scope'              => 'core',
	...
	public function register(): void {
		...
		$option_name = 'wpshadow_asset-version-removal_remove_js_versions';
		...
		add_filter( 'script_loader_src', array( $this, 'remove_version' ), 10 );
	}
