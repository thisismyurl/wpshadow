...
define( 'WPSHADOW_VERSION', '1.6035.0948' );
...
/**
 * Initialize security hardening (must run early)
 */
require_once WPSHADOW_PATH . 'includes/systems/core/class-rate-limiter.php';
require_once WPSHADOW_PATH . 'includes/systems/core/class-file-integrity-monitor.php';
require_once WPSHADOW_PATH . 'includes/systems/core/class-treatment-sandbox.php';
require_once WPSHADOW_PATH . 'includes/systems/core/class-security-hardening-manager.php';
\WPShadow\Core\Security_Hardening_Manager::init();
