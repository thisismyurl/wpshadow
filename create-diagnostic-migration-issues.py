...
# Issue 1: Mobile Friendliness Diagnostics
issue1 = {
...
''',
    'labels': ['enhancement', 'diagnostics', 'mobile', 'architecture']
}

# Issue 2: Accessibility Diagnostics
issue2 = {
...
''',
    'labels': ['enhancement', 'diagnostics', 'accessibility', 'architecture', 'wcag']
}

# Issue 3: Broken Link Checker Diagnostics
issue3 = {
...
''',
    'labels': ['enhancement', 'diagnostics', 'seo', 'architecture']
}

# Use curl to create issues
issues = [issue1, issue2, issue3]
created = []

for issue in issues:
    # Write issue data to temp file
    ...
    if result.returncode == 0:
        try:
            ...
            print(f"❌ Failed to parse response for: {issue['title']}")
            print(f"   Error: {e}")
...
print(f"\n📊 Summary: Created {len(created)} issues")
