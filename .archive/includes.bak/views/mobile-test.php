...
<div class="wrap wpshadow-mobile-test">
	<h1><?php esc_html_e( 'Mobile-Friendliness Test', 'wpshadow' ); ?></h1>

	<p class="description">
		<?php esc_html_e( 'Test your website\'s mobile-friendliness by analyzing viewport configuration, touch target sizes, text readability, and layout responsiveness.', 'wpshadow' ); ?>
	</p>

	<div class="wpshadow-mobile-test-container">
		<div class="wpshadow-test-controls">
			<h2><?php esc_html_e( 'Test Configuration', 'wpshadow' ); ?></h2>
			...
			<form method="post" action="options.php" class="wpshadow-mobile-options-form">
				...
				<table class="form-table">
					<tbody>
						<tr>
							<th scope="row"><?php esc_html_e( 'URL to Test', 'wpshadow' ); ?></th>
							<td>
								...
								<p class="description"><?php esc_html_e( 'Enter a URL to test, or leave empty to test your homepage.', 'wpshadow' ); ?></p>
							</td>
						</tr>

						<tr>
							<th scope="row"><?php esc_html_e( 'Test Options', 'wpshadow' ); ?></th>
							<td>
								<fieldset>
									<label>
										...
										<?php esc_html_e( 'Check viewport configuration', 'wpshadow' ); ?>
									</label>
									<br />
									<label>
										...
										<?php esc_html_e( 'Check touch target sizes', 'wpshadow' ); ?>
									</label>
									<br />
									<label>
										...
										<?php esc_html_e( 'Check text readability', 'wpshadow' ); ?>
									</label>
									<br />
									<label>
										...
										<?php esc_html_e( 'Check tap spacing', 'wpshadow' ); ?>
									</label>
								</fieldset>
							</td>
						</tr>
						...
						<tr>
							<th scope="row"><?php esc_html_e( 'Minimum Touch Target Size', 'wpshadow' ); ?></th>
							<td>
								...
								<span class="description"><?php esc_html_e( 'pixels (W3C recommends 44px minimum)', 'wpshadow' ); ?></span>
							</td>
						</tr>

						<tr>
							<th scope="row"><?php esc_html_e( 'Minimum Font Size', 'wpshadow' ); ?></th>
							<td>
								...
								<span class="description"><?php esc_html_e( 'pixels', 'wpshadow' ); ?></span>
							</td>
						</tr>

						<tr>
							<th scope="row"><?php esc_html_e( 'Auto-check on Save', 'wpshadow' ); ?></th>
							<td>
								<label>
									...
									<?php esc_html_e( 'Automatically run mobile-friendliness test when posts are saved', 'wpshadow' ); ?>
								</label>
							</td>
						</tr>
					</tbody>
				...
				<?php submit_button( __( 'Save Settings', 'wpshadow' ), 'secondary' ); ?>
			</form>
			...
			<div class="wpshadow-test-actions">
				<button type="button" id="wpshadow-run-mobile-test" class="button button-primary button-large">
					...
					<?php esc_html_e( 'Run Mobile Test', 'wpshadow' ); ?>
				</button>
			</div>
		</div>

		<div class="wpshadow-test-results" id="wpshadow-test-results" style="display: none;">
			<h2><?php esc_html_e( 'Test Results', 'wpshadow' ); ?></h2>

			<div class="wpshadow-test-loading" id="wpshadow-test-loading">
				<div class="spinner is-active"></div>
				<p><?php esc_html_e( 'Running mobile-friendliness test...', 'wpshadow' ); ?></p>
			</div>
				...
				<div class="wpshadow-test-details">
					<div class="test-section" id="test-issues" style="display: none;">
						<h3 class="test-section-title">
							...
							<?php esc_html_e( 'Issues Found', 'wpshadow' ); ?>
						</h3>
					...
					<div class="test-section" id="test-warnings" style="display: none;">
						<h3 class="test-section-title">
							...
							<?php esc_html_e( 'Warnings', 'wpshadow' ); ?>
						</h3>
					...
					<div class="test-section" id="test-passes" style="display: none;">
						<h3 class="test-section-title">
							...
							<?php esc_html_e( 'Passed Checks', 'wpshadow' ); ?>
						</h3>
					...
					<div class="test-section" id="test-recommendations" style="display: none;">
						<h3 class="test-section-title">
							...
							<?php esc_html_e( 'Recommendations', 'wpshadow' ); ?>
						</h3>
