...
$current_tab = isset( $_GET['help_section'] ) ? sanitize_key( $_GET['help_section'] ) : 'overview'; 

$help_content = WPSHADOW_Help_Content_API::get_content();

$tabs = array(
	'overview'        => __( 'Overview', 'wpshadow' ),
	'getting-started' => __( 'Getting Started', 'wpshadow' ),
	'modules'         => __( 'Modules', 'wpshadow' ),
	'faq'             => __( 'FAQ', 'wpshadow' ),
);
...
<div class="wrap wps-help-page">
	<h1><?php esc_html_e( 'Help & Documentation', 'wpshadow' ); ?></h1>

	<!-- NOTE: License widget removed - licensing is PRO plugin only -->

	<!-- Help Tab Navigation -->
	<nav class="wps-help-tabs nav-tab-wrapper wp-clearfix" role="navigation" aria-label="<?php esc_attr_e( 'Help sections', 'wpshadow' ); ?>">
	...
	<div class="wps-help-content">
		...
		<?php else : ?>
			...
			<div class="wps-help-section wps-help-error">
				<p><?php esc_html_e( 'Help content is currently unavailable. Please try refreshing the page.', 'wpshadow' ); ?></p>
			</div>
		<?php endif; ?>

		<!-- Support Links -->
		<div class="wps-help-footer">
			<h3><?php esc_html_e( 'Additional Resources', 'wpshadow' ); ?></h3>
			<ul class="wps-help-links">
				<li>
					<span class="dashicons dashicons-book" aria-hidden="true"></span>
					<a href="https:
						<?php esc_html_e( 'Full Documentation', 'wpshadow' ); ?>
					</a>
				</li>
				<li>
					<span class="dashicons dashicons-admin-generic" aria-hidden="true"></span>
					<a href="https:
						<?php esc_html_e( 'GitHub Repository', 'wpshadow' ); ?>
					</a>
				</li>
				<li>
					<span class="dashicons dashicons-sos" aria-hidden="true"></span>
					<a href="https:
						<?php esc_html_e( 'Professional Support', 'wpshadow' ); ?>
					</a>
				</li>
			</ul>
		</div>
