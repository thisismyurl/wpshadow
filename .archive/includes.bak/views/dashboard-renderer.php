	...
	<div class="wpshadow-settings-container" data-subfeature="advanced_settings" style="margin-top: 12px; padding: 12px; background: #f5f5f5; border-radius: 4px;">
		<div style="margin-bottom: 16px;">
			...
			<textarea id="wpshadow-external-fonts-whitelist" 
				style="width: 100%; height: 100px; font-family: monospace; font-size: 12px; padding: 8px; border: 1px solid #ddd; border-radius: 4px;"
				placeholder="<?php esc_attr_e( 'https://fonts.googleapis.com\nhttps://fonts.gstatic.com', 'wpshadow' ); ?>"><?php echo esc_textarea( $whitelist_urls ); ?></textarea>
			<p style="margin: 8px 0 0 0; font-size: 11px; color: #999;">
...
function wpshadow_render_help_resources_widget(): void {
	...
	<div class="wpshadow-widget-content">
		...
		<ul style="list-style: none; padding: 0;">
			<li style="margin-bottom: 10px;"><a href="https:
			<li style="margin-bottom: 10px;"><a href="https:
			<li style="margin-bottom: 10px;"><a href="https:
		</ul>
	</div>
	...
	if ( false === $disk_free || false === $disk_total ) {
		...
		if ( $df_output ) {
			...
			if ( isset( $df_parts[1], $df_parts[2] ) ) {
				$disk_total = (int) $df_parts[1] * 1024; 
