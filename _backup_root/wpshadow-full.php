...
use WPShadow\CoreSupport\WPSHADOW_Feature_Emergency_Support;
use WPShadow\CoreSupport\WPSHADOW_Feature_Magic_Link_Support;
...
function WPSHADOW_register_core_features(): void {
	...
	register_WPSHADOW_feature( new WPSHADOW_Feature_Emergency_Support() );
	register_WPSHADOW_feature( new WPSHADOW_Feature_Magic_Link_Support() );
...
function wpshadow_init(): void {
	...
	require_once str_replace( '/', DIRECTORY_SEPARATOR, WPSHADOW_PATH . 'features/class-wps-feature-emergency-support.php' );
	require_once str_replace( '/', DIRECTORY_SEPARATOR, WPSHADOW_PATH . 'features/class-wps-feature-magic-link-support.php' );
