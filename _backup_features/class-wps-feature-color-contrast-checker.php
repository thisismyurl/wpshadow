...
final class WPSHADOW_Feature_Color_Contrast_Checker extends WPSHADOW_Abstract_Feature {
	...
	public function __construct() {
		parent::__construct(
			array(
				...
				'name'               => __( 'Color Contrast Checker', 'wpshadow' ),
				'description'        => __( 'Check your text colors are readable and meet accessibility standards.', 'wpshadow' ),
				'scope'              => 'core',
				...
				'priority'           => 15,
				'sub_features'       => array(
					'report_wcag_aaa'   => __( 'Report WCAG AAA Failures', 'wpshadow' ),
					'log_violations'    => __( 'Log Color Contrast Violations', 'wpshadow' ),
					'suggest_compliant' => __( 'Auto-Suggest Compliant Colors', 'wpshadow' ),
				),
				'aliases'            => array(
					'accessibility',
					'wcag',
	...
	public function render_checker_page(): void {
		...
		<div class="wrap wpshadow-color-contrast-checker">
			<h1><?php echo esc_html__( 'Color Contrast Checker', 'wpshadow' ); ?></h1>
			<p><?php echo esc_html__( 'Test color combinations to ensure they meet WCAG accessibility standards for text readability.', 'wpshadow' ); ?></p>

			<div class="wps-contrast-checker-container">
				<div class="wps-contrast-inputs">
					<div class="wps-input-group">
						<label for="wps-text-color">
							<?php echo esc_html__( 'Text Color', 'wpshadow' ); ?>
						</label>
					...
					<div class="wps-input-group">
						<label for="wps-background-color">
							<?php echo esc_html__( 'Background Color', 'wpshadow' ); ?>
						</label>
				...
				<div class="wps-contrast-results" id="wps-results" style="display: none;">
					...
					<div class="wps-info-box">
						<p>
							<strong><?php echo esc_html__( 'WCAG Standards:', 'wpshadow' ); ?></strong><br>
							• <strong>AA</strong> <?php echo esc_html__( '(Minimum):', 'wpshadow' ); ?> 
							<?php echo esc_html__( '4.5:1 for normal text, 3:1 for large text', 'wpshadow' ); ?><br>
							• <strong>AAA</strong> <?php echo esc_html__( '(Enhanced):', 'wpshadow' ); ?> 
							<?php echo esc_html__( '7:1 for normal text, 4.5:1 for large text', 'wpshadow' ); ?>
						</p>
					</div>
				</div>
			</div>
