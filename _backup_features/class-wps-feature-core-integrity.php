...
final class WPSHADOW_Feature_Core_Integrity extends WPSHADOW_Abstract_Feature {
	...
	public function __construct() {
		parent::__construct(
			array(
				'id'                 => 'core-integrity',
				'name'               => __( 'WordPress Core File Verification', 'wpshadow' ),
				'description'        => __( 'Regularly verifies WordPress core files against official checksums, alerts when differences appear, and can restore clean copies after backing up any changed file. Runs in the background to catch tampering or corruption early, lowers risk of compromised core code, and integrates with dashboards so administrators can repair issues quickly while keeping the site stable.', 'wpshadow' ),
				'scope'              => 'core',
			...
			'widget_group'       => 'maintenance-tools',
				...
				'priority'           => 5,
				'sub_features'       => array(
					'enable_auto_repair'     => __( 'Enable Automatic Repair', 'wpshadow' ),
					'email_alerts'           => __( 'Email Alerts on File Changes', 'wpshadow' ),
					'exclude_non_critical'   => __( 'Exclude Non-Critical Files from Scan', 'wpshadow' ),
				),
				'aliases'            => array(
					'file integrity',
					'tamper detection',
