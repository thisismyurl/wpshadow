...
sed -i "s/Version: 1\.[0-9]\{3,4\}\.[0-9]\+/Version: $NEW_VERSION/" wpshadow.php
sed -i "s/define( 'WPSHADOW_VERSION', '1\.[0-9]\{3,4\}\.[0-9]\+' );/define( 'WPSHADOW_VERSION', '$NEW_VERSION' );/" wpshadow.php

# Update version in readme.txt
sed -i "s/Stable tag: 1\.[0-9]\{3,4\}\.[0-9]\+/Stable tag: $NEW_VERSION/" readme.txt
