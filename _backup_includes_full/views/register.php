...
<div class="wrap wps-register-page">
	<h1><?php esc_html_e( 'Register WPShadow', 'wpshadow' ); ?></h1>
	
	<?php if ( $is_licensed ) : ?>
		<div class="notice notice-success">
			<p><strong><?php esc_html_e( 'Your site is already registered!', 'wpshadow' ); ?></strong></p>
			<p><?php esc_html_e( 'You have an active license and are receiving updates and support.', 'wpshadow' ); ?></p>
		</div>
		<p>
			<a href="<?php echo esc_url( admin_url( 'admin.php?page=wpshadow&WPSHADOW_tab=dashboard_settings' ) ); ?>" class="button button-primary">
				<?php esc_html_e( 'Manage License', 'wpshadow' ); ?>
			</a>
		</p>
	<?php else : ?>
		...
		<div class="wps-register-benefits">
			<div class="wps-benefits-intro">
				<h2><?php esc_html_e( 'Why Register?', 'wpshadow' ); ?></h2>
				<p class="description">
					<?php esc_html_e( 'Registration is free and provides you with essential benefits to keep your WordPress site secure and optimized.', 'wpshadow' ); ?>
				</p>
			</div>
			...
			<div class="wps-benefits-grid">
				<div class="wps-benefit-card">
					...
					<h3><?php esc_html_e( 'Automatic Updates', 'wpshadow' ); ?></h3>
					<p><?php esc_html_e( 'Receive automatic plugin updates with the latest features, security patches, and performance improvements.', 'wpshadow' ); ?></p>
				</div>

				<div class="wps-benefit-card">
					<span class="dashicons dashicons-shield"></span>
					<h3><?php esc_html_e( 'Security Notifications', 'wpshadow' ); ?></h3>
					<p><?php esc_html_e( 'Get immediate alerts about security vulnerabilities and critical issues affecting your WordPress installation.', 'wpshadow' ); ?></p>
				</div>

				<div class="wps-benefit-card">
					<span class="dashicons dashicons-sos"></span>
					<h3><?php esc_html_e( 'Priority Support', 'wpshadow' ); ?></h3>
					<p><?php esc_html_e( 'Access to dedicated support team for troubleshooting, questions, and technical assistance.', 'wpshadow' ); ?></p>
				</div>

				<div class="wps-benefit-card">
					<span class="dashicons dashicons-admin-plugins"></span>
					<h3><?php esc_html_e( 'Premium Features', 'wpshadow' ); ?></h3>
					<p><?php esc_html_e( 'Unlock advanced features including performance optimization, backup verification, and site documentation tools.', 'wpshadow' ); ?></p>
				</div>
			</div>
		</div>
		...
		<div class="wps-register-form-container">
			<h2><?php esc_html_e( 'Create Your Free Account', 'wpshadow' ); ?></h2>
			<p class="description">
				<?php esc_html_e( 'Fill in the details below to register your site. Your information is pre-populated from your WordPress settings.', 'wpshadow' ); ?>
			</p>
			...
			<form id="wps-register-form" method="post" action="">
				...
				<table class="form-table" role="presentation">
					<tbody>
						<tr>
							<th scope="row">
								<label for="wpshadow_site_name"><?php esc_html_e( 'Site Name', 'wpshadow' ); ?></label>
							</th>
							<td>
								<input type="text" id="wpshadow_site_name" name="wpshadow_site_name" 
										value="<?php echo esc_attr( $site_title ); ?>" 
										class="regular-text" required />
								<p class="description"><?php esc_html_e( 'The name of your WordPress site.', 'wpshadow' ); ?></p>
							</td>
						</tr>

						<tr>
							<th scope="row">
								<label for="wpshadow_site_url"><?php esc_html_e( 'Site URL', 'wpshadow' ); ?></label>
							</th>
							<td>
								...
								<p class="description"><?php esc_html_e( 'Your WordPress site URL (cannot be changed).', 'wpshadow' ); ?></p>
							</td>
						</tr>

						<tr>
							<th scope="row">
								<label for="wpshadow_admin_name"><?php esc_html_e( 'Your Name', 'wpshadow' ); ?></label>
							</th>
							<td>
								<input type="text" id="wpshadow_admin_name" name="wpshadow_admin_name" 
										value="<?php echo esc_attr( $current_user->display_name ); ?>" 
										class="regular-text" required />
								<p class="description"><?php esc_html_e( 'Your full name or display name.', 'wpshadow' ); ?></p>
							</td>
						</tr>

						<tr>
							<th scope="row">
								<label for="wpshadow_admin_email"><?php esc_html_e( 'Email Address', 'wpshadow' ); ?></label>
							</th>
							<td>
								<input type="email" id="wpshadow_admin_email" name="wpshadow_admin_email" 
										value="<?php echo esc_attr( $current_user->user_email ); ?>" 
										class="regular-text" required />
								<p class="description"><?php esc_html_e( 'We will use this email to send you updates and important notifications.', 'wpshadow' ); ?></p>
							</td>
						</tr>

						<tr>
							<th scope="row">
								<?php esc_html_e( 'Email Preferences', 'wpshadow' ); ?>
							</th>
							<td>
								<fieldset>
									...
									<label for="wpshadow_opt_in_updates">
										...
										<?php esc_html_e( 'Receive plugin update notifications (recommended)', 'wpshadow' ); ?>
									</label>
									<br />
									<label for="wpshadow_opt_in_security">
										...
										<?php esc_html_e( 'Receive security alerts and important announcements (recommended)', 'wpshadow' ); ?>
									</label>
									<br />
									<label for="wpshadow_opt_in_newsletter">
										...
										<?php esc_html_e( 'Subscribe to newsletter for WordPress tips and best practices', 'wpshadow' ); ?>
									</label>
									<br />
									<label for="wpshadow_opt_in_marketing">
										...
										<?php esc_html_e( 'Receive promotional offers and product announcements', 'wpshadow' ); ?>
									</label>
								</fieldset>
							</td>
						</tr>
						...
						<tr>
							<th scope="row">
								<?php esc_html_e( 'Terms & Privacy', 'wpshadow' ); ?>
							</th>
							<td>
								<label for="wpshadow_agree_terms">
									...
									printf(
										...
										wp_kses_post( __( 'I agree to the <a href="%1$s" target="_blank">Terms of Service</a> and <a href="%2$s" target="_blank">Privacy Policy</a>', 'wpshadow' ) ),
				...
				<p class="submit">
					<button type="submit" class="button button-primary button-hero" id="wps-register-submit">
						<?php esc_html_e( 'Register My Site', 'wpshadow' ); ?>
					</button>
			...
			<div class="wps-register-footer">
				<p>
					<strong><?php esc_html_e( 'Already have a license key?', 'wpshadow' ); ?></strong>
					<a href="<?php echo esc_url( admin_url( 'admin.php?page=wpshadow&WPSHADOW_tab=dashboard_settings' ) ); ?>">
						<?php esc_html_e( 'Enter it in settings instead', 'wpshadow' ); ?>
					</a>
				</p>
			</div>
		</div>
	...
	$('#wps-register-form').on('submit', function(e) {
		...
		if (!$('#WPSHADOW_agree_terms').is(':checked')) {
			$message.removeClass('success').addClass('error')
				.text('<?php echo esc_js( __( 'You must agree to the Terms of Service and Privacy Policy to register.', 'wpshadow' ) ); ?>')
				.show();
			return;
		}
		...
		$.ajax({
			...
			success: function(response) {
				...
				if (response.success) {
					...
					$message.removeClass('success').addClass('error')
						.text(response.data.message || '<?php echo esc_js( __( 'Registration failed. Please try again.', 'wpshadow' ) ); ?>')
						.show();
				}
			},
			error: function(xhr, status, error) {
				...
				$spinner.removeClass('is-active');
				$message.removeClass('success').addClass('error')
					.text('<?php echo esc_js( __( 'An error occurred. Please check your internet connection and try again.', 'wpshadow' ) ); ?>')
					.show();
			}
		});
	});
