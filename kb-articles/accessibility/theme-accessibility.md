...
tags: ["wordpress", "accessibility", "theme-accessibility"]
...
related_articles:
  - "[related-article-1]"
  - "[related-article-2]"
wp_link: "https://wpshadow.com/kb/theme-accessibility"
...
> **Read on WPShadow:** For the latest version and community discussion, [visit this article on WPShadow.com →](https://wpshadow.com/kb/theme-accessibility)
...
3. **Find "Theme Accessibility"** → Shows the issue
...
Found an issue with this article? [**Edit on GitHub** →](https://github.com/thisismyurl/wpshadow/blob/main/kb-articles/accessibility/theme-accessibility.md)
