	...
	public function __construct() {
		...
		if ( method_exists( $this, 'register_sub_features' ) ) {
			$this->register_sub_features(
				array(
					'disable_embed_script' => __( 'Disable wp-embed.js Script', 'wpshadow' ),
					'remove_oembed_links'  => __( 'Remove oEmbed Discovery Links', 'wpshadow' ),
					'disable_rest_oembed'  => __( 'Disable REST API oEmbed Endpoint', 'wpshadow' ),
					'remove_embed_rewrite' => __( 'Remove Embed Rewrite Rules', 'wpshadow' ),
				)
			);
		}
